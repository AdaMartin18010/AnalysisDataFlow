...
| F3 | Hoare C.A.R. **"Communicating Sequential Processes"** | Prentice Hall | 1985 | 书籍 | CSP 的完整书籍，形式化并发程序设计的标准参考 |
...
| F6 | Sangiorgi D., Walker D. **"The π-Calculus: A Theory of Mobile Processes"** | Cambridge University Press | 2001 | 书籍 | π-演算的权威教材，涵盖理论和应用 |
...
| F9 | Gay S.J., Hole M. **"Types and Subtypes for Client-Server Interactions"** | ESOP | 1999 | PDF | 客户端-服务器交互的类型系统，会话类型的应用 |
...
| F21 | Joshi R., Lamport L., Matthews J., et al. **"Checking Cache-Coherence Protocols with TLA+"** | Form. Methods Syst. Des. | 2003 | PDF | 使用 TLA+ 验证缓存一致性协议 |
...
| 编号 | 作者 | 书名 | 出版社 | 年份 | 链接 |
|------|------|------|--------|------|------|
| B16 | Hoare C.A.R. | **Communicating Sequential Processes** | Prentice Hall | 1985 | UsingCSP |
...
| B20 | Sangiorgi D., Walker D. | **The π-Calculus: A Theory of Mobile Processes** | Cambridge University Press | 2001 | CUP |
