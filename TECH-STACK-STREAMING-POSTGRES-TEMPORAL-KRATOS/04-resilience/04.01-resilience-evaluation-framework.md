...
本文档描述的弹性评价框架与项目现有知识库存在以下关联：

- [Flink 生产检查清单](../../Knowledge/07-best-practices/07.01-flink-production-checklist.md) — 生产环境十项检查清单与 RES 评分的映射
- [高可用模式](../../Knowledge/07-best-practices/07.06-high-availability-patterns.md) — Flink 高可用架构与 RML-4  maturity 的对齐
- [背压与流控](../../Flink/02-core/backpressure-and-flow-control.md) — Flink 背压机制对舱壁隔离与爆炸半径的量化影响
- [性能调优模式](../../Knowledge/07-best-practices/07.02-performance-tuning-patterns.md) — 弹性与性能权衡的工程决策框架
