...
本文档描述的混沌工程实践与项目现有知识库存在以下关联：

- [高可用模式](../../Knowledge/07-best-practices/07.06-high-availability-patterns.md) — 混沌工程验证的高可用设计模式与最佳实践
- [Flink 生产检查清单](../../Knowledge/07-best-practices/07.01-flink-production-checklist.md) — 生产环境检查清单与混沌实验假设的映射
- [Checkpoint 机制深度解析](../../Flink/02-core/checkpoint-mechanism-deep-dive.md) — TaskManager 故障注入与 Checkpoint 恢复的形式化验证
- [故障排查指南](../../Knowledge/07-best-practices/07.03-troubleshooting-guide.md) — 混沌实验发现的故障模式与排查方法
