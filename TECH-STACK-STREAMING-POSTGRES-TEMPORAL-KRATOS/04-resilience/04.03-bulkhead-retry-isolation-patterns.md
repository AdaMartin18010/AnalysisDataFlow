...
本文档描述的舱壁与重试隔离模式与项目现有知识库存在以下关联：

- [高可用模式](../../Knowledge/07-best-practices/07.06-high-availability-patterns.md) — 舱壁、重试与断路器的组合高可用设计模式
- [背压与流控](../../Flink/02-core/backpressure-and-flow-control.md) — Flink Credit-based 流控与资源隔离的协同机制
- [性能调优模式](../../Knowledge/07-best-practices/07.02-performance-tuning-patterns.md) — 重试预算与抖动退避的性能优化策略
- [故障排查指南](../../Knowledge/07-best-practices/07.03-troubleshooting-guide.md) — 重试风暴与资源耗尽类故障的诊断方法
