...
本文档描述的容错组合证明与项目现有知识库存在以下关联：

- [高可用模式](../../Knowledge/07-best-practices/07.06-high-availability-patterns.md) — 容错组合在生产高可用架构中的工程实现
- [Checkpoint 机制深度解析](../../Flink/02-core/checkpoint-mechanism-deep-dive.md) — Flink 容错机制的形式化基础
- [Exactly-Once 语义深度解析](../../Flink/02-core/exactly-once-semantics-deep-dive.md) — 端到端容错语义的形式化分析
- [事务流处理深度解析](../../Knowledge/06-frontier/transactional-stream-processing-deep-dive.md) — 分布式事务与容错组合的理论关联
