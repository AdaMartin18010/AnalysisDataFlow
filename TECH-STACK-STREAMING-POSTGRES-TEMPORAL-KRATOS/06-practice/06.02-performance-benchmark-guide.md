...
| 变更捕获 | Debezium / pgoutput | 10ms | 50ms | 10% |
| 消息队列 | Kafka 端到端 | 5ms | 20ms | 40% |
| 流处理 | Flink 处理 + Checkpoint | 20ms | 80ms | 20% |
| 工作流编排 | Temporal Task 调度 | 10ms | 40ms | 3% |
| 服务调用 | Kratos gRPC | 2ms | 5ms | 24% |
