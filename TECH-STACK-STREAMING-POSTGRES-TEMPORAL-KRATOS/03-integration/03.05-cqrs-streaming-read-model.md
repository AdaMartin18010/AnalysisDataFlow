...
本文档描述的 CQRS + 流式读模型与项目现有知识库存在以下关联：

- [流数据库前沿](../../Knowledge/06-frontier/streaming-databases.md) — 流式物化视图与读模型的技术选型参考
- [Flink 状态管理完整指南](../../Flink/02-core/flink-state-management-complete-guide.md) — Flink 增量聚合与状态后端的工程细节
- [数据网格流式集成](../../Knowledge/03-business-patterns/data-mesh-streaming-integration.md) — CQRS 读写分离与数据网格分层映射
- [实时数据网格实践](../../Knowledge/06-frontier/realtime-data-mesh-practice.md) — 读模型作为数据产品的工程实践
