...
本文档描述的 CDC 管道集成与项目现有知识库存在以下关联：

- [Flink CDC Debezium 集成指南](../../Flink/05-ecosystem/05.01-connectors/04.04-cdc-debezium-integration.md) — Debezium 作为 CDC 捕获层的深度配置
- [Flink CDC 3.0 数据集成](../../Flink/05-ecosystem/05.01-connectors/flink-cdc-3.0-data-integration.md) — CDC 管道的端到端数据集成框架
- [端到端 Exactly-Once](../../Flink/02-core/exactly-once-end-to-end.md) — CDC 管道端到端一致性的完整论证
- [Checkpoint 机制深度解析](../../Flink/02-core/checkpoint-mechanism-deep-dive.md) — Flink Checkpoint 与 Kafka Offset 耦合事务的实现
