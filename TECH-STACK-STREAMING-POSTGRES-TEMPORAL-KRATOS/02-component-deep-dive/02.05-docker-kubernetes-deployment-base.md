...
本文档描述的 K8s 部署底座与项目现有知识库存在以下关联：

- [Flink Kubernetes 部署指南](../../Flink/04-runtime/04.01-deployment/kubernetes-deployment.md) — Flink 在 K8s 上的原生部署模式与配置
- [Flink Kubernetes Operator 深度解析](../../Flink/04-runtime/04.01-deployment/flink-kubernetes-operator-deep-dive.md) — 生产级 Flink K8s Operator 的架构与运维
- [Kubernetes 生产部署指南](../../Flink/04-runtime/04.01-deployment/kubernetes-deployment-production-guide.md) — K8s 部署的工程最佳实践
- [高可用模式](../../Knowledge/07-best-practices/07.06-high-availability-patterns.md) — 五技术栈在 K8s 上的高可用设计模式
