...
本文档描述的数据流与控制流分析与项目现有知识库存在以下关联：

- [流计算模型思维导图](../../Knowledge/01-concept-atlas/streaming-models-mindmap.md) — 五技术栈在流计算模型谱系中的定位
- [数据网格流式集成](../../Knowledge/03-business-patterns/data-mesh-streaming-integration.md) — 数据流边界与数据产品自治的映射
- [Flink 状态管理完整指南](../../Flink/02-core/flink-state-management-complete-guide.md) — Flink 内部数据流与状态传递的工程实现
- [Temporal + Flink 分层架构](../../Knowledge/06-frontier/temporal-flink-layered-architecture.md) — 控制流与数据流正交互补的架构论证
