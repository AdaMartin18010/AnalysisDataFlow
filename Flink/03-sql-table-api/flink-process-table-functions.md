...
[^1]: Apache Flink Documentation, "Process Table Functions (PTF)", 2026. https://nightlies.apache.org/flink/flink-docs-stable/docs/dev/table/functions/udfs/#process-table-functions

[^2]: Confluent Cloud Documentation, "Process Table Functions Early Access", March 2025. https://docs.confluent.io/cloud/current/flink/reference/functions/process-table-functions.html

[^3]: Apache Flink FLIP-291, "Process Table Functions", 2024. https://cwiki.apache.org/confluence/pages/viewpage.action?pageId=255070955
...
[^6]: Apache Flink Documentation, "User-Defined Functions (UDFs)", 2025. https://nightlies.apache.org/flink/flink-docs-stable/docs/dev/table/functions/udfs/

[^7]: M. Armbrust et al., "Structured Streaming: A Declarative API for Real-Time Applications in Apache Spark", SIGMOD, 2018.

[^8]: Apache Flink Roadmap, "Flink 2.x PTF Enhancements", 2025. https://flink.apache.org/roadmap/

[^9]: R. M. G. V. Almeida et al., "Windowing in Stream Processing: A Survey", SIGMOD Record, 2024.

[^10]: Apache Flink GitHub, "Process Table Function Implementation", 2025. https://github.com/apache/flink/tree/master/flink-table/flink-table-runtime/src/main/java/org/apache/flink/table/runtime/operators/process
