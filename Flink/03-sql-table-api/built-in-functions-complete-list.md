...
> **所属阶段**: Flink/03-sql-table-api | **前置依赖**: [Flink SQL 概述](../01-architecture/flink-1.x-vs-2.0-comparison.md) | **形式化等级**: L3 | **版本兼容**: Flink 1.17-1.20
...
> 🗂️ **适用版本**: Flink 1.14+ | 🟢 **稳定状态** | 🔵 Since 1.14
...
> 📌 **文档版本**: v1.0 | **更新日期**: 2026-04-04 | **兼容版本**: Flink 1.17-1.20
