...
[^9]: Confluent Documentation, "Schema Evolution and Compatibility", 2025. <https://docs.confluent.io/platform/current/schema-registry/avro.html>

[^10]: Apache Kafka Documentation, "Producer Configs", 2025. <https://kafka.apache.org/documentation/producer-configs>

[^11]: Apache Kafka Documentation, "Consumer Configs", 2025. <https://kafka.apache.org/documentation/consumer-configs>

[^12]: K. M. Chandy and L. Lamport, "Distributed Snapshots: Determining Global States of Distributed Systems", *ACM Trans. Comput. Syst.*, 3(1), 1985.
