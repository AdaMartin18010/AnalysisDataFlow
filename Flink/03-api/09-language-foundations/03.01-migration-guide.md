...
class FlinkMigrationHelper:
    ...
    def migrate_source_sink(self, content: str) -> str:
        ...
        if 'FlinkKafkaConsumer010' in content or 'FlinkKafkaProducer010' in content:
            content = """// TODO: 手动迁移 Kafka 连接器到新版 API
// 参考: https://nightlies.apache.org/flink/flink-docs-stable/docs/connectors/datastream/kafka/
""" + content
            self.changes_made.append("添加 Kafka 连接器迁移 TODO")
