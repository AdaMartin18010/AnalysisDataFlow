...
> 所属阶段: Flink/09-language-foundations | 前置依赖: [Flink 1.x vs 2.0 架构对比](../../01-concepts/flink-1.x-vs-2.0-comparison.md), [Scala API 迁移指南](./03.01-migration-guide.md) | 形式化等级: L4
