...
> 所属阶段: Flink/09-language-foundations | 前置依赖: [Flink 1.x vs 2.0 架构对比](Flink/01-concepts/flink-1.x-vs-2.0-comparison.md), [Scala API 迁移指南](./03.01-migration-guide.md) | 形式化等级: L4

---

## 目录

- [flink-scala-api 社区版完整指南 (Flink 2.0 + Scala 3)](#flink-scala-api-社区版完整指南-flink-20--scala-3)
  - [目录](#目录)
  ...
  - [3. 关系建立 (Relations)](#3-关系建立-relations)
    ...
    - [3.2 与 Flink Java API 的互操作性](#32-与-flink-java-api-的互操作性)
    - [3.3 与 Flink 2.0 新特性的集成](#33-与-flink-20-新特性的集成)
  ...
  - [6. 实例验证 (Examples)](#6-实例验证-examples)
    - [6.1 项目模板结构](#61-项目模板结构)
    - [6.2 SBT 配置 (Scala 2.13 与 3.x)](#62-sbt-配置-scala-213-与-3x)
    - [6.3 WordCount (Scala 3 特性)](#63-wordcount-scala-3-特性)
    - [6.4 复杂 ADT 序列化](#64-复杂-adt-序列化)
    - [6.5 有状态处理 (ValueState)](#65-有状态处理-valuestate)
    - [6.6 Table API + DataStream 集成](#66-table-api--datastream-集成)
  - [7. 可视化 (Visualizations)](#7-可视化-visualizations)
    - [7.1 官方 API vs 社区 API 架构对比](#71-官方-api-vs-社区-api-架构对比)
    - [7.2 序列化机制决策树](#72-序列化机制决策树)
    - [7.3 Flink 2.0 集成架构图](#73-flink-20-集成架构图)
    - [7.4 项目构建流程图](#74-项目构建流程图)
  - [8. 生产最佳实践](#8-生产最佳实践)
    - [8.1 Kryo 禁用测试](#81-kryo-禁用测试)
    - [8.2 Schema 演进规则](#82-schema-演进规则)
    - [8.3 性能调优](#83-性能调优)
    - [8.4 CI/CD GitHub Actions 配置](#84-cicd-github-actions-配置)
  - [9. 故障排除](#9-故障排除)
    - [9.1 常见编译错误](#91-常见编译错误)
    - [9.2 TypeInformation 派生失败](#92-typeinformation-派生失败)
    - [9.3 State Descriptor 问题](#93-state-descriptor-问题)
    - [9.4 从官方 Scala API 迁移](#94-从官方-scala-api-迁移)
  - [10. 与 Java API 对比](#10-与-java-api-对比)
    - [10.1 类型安全对比](#101-类型安全对比)
    - [10.2 样板代码减少度量](#102-样板代码减少度量)
    - [10.3 性能基准](#103-性能基准)
  - [11. 引用参考](#11-引用参考)
