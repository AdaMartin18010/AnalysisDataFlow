...
[^1]: WebAssembly Community Group, "WebAssembly 3.0 Specification", W3C, January 2026. https://webassembly.github.io/spec/core/

[^2]: Uno Platform, "The State of WebAssembly 2025-2026", Platform.uno Blog, January 2026. https://platform.uno/blog/the-state-of-webassembly-2025-2026/

[^3]: WebAssembly Community Group, "WebAssembly Proposals", GitHub, 2026. https://github.com/WebAssembly/proposals

[^4]: WebAssembly Feature Detection, "WebAssembly Feature Matrix", 2026. https://webassembly.org/features/

[^5]: Apple Inc., "Safari 18.4 Release Notes", 2025. https://developer.apple.com/documentation/safari-release-notes/safari-18_4-release-notes

[^6]: Mozilla Developer Network, "WebAssembly Exception Handling", MDN Web Docs, 2025. https://developer.mozilla.org/en-US/docs/WebAssembly/Guides/Exception_handling

[^7]: Chrome Platform Status, "WebAssembly Memory64", 2025. https://chromestatus.com/feature/6174848176205824

[^8]: Bytecode Alliance, "WASI 0.3 Roadmap", 2026. https://wasi.dev/

[^9]: Microsoft, ".NET 10 WebAssembly Support", .NET Blog, November 2025.

[^10]: JetBrains, "Kotlin/Wasm Beta", Kotlin Blog, September 2025.
