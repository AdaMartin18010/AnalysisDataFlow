...
[^1]: NVIDIA TensorRT Documentation, "Optimizing Deep Learning Inference", 2024. https://docs.nvidia.com/deeplearning/tensorrt/

[^2]: ONNX Runtime Documentation, "Performance Tuning", 2024. https://onnxruntime.ai/docs/performance/

[^3]: vLLM Documentation, "PagedAttention", 2024. https://docs.vllm.ai/

[^4]: H. Wu et al., "vLLM: Easy, Fast, and Cheap LLM Serving with PagedAttention", SOSP 2023.

[^5]: T. Dettmers et al., "LLM.int8(): 8-bit Matrix Multiplication for Transformers at Scale", NeurIPS 2022.

[^6]: E. Frantar et al., "GPTQ: Accurate Post-Training Quantization for Generative Pre-trained Transformers", ICLR 2023.

[^7]: J. Lin et al., "AWQ: Activation-aware Weight Quantization for LLM Compression and Acceleration", MLSys 2024.

[^8]: T. Dao et al., "FlashAttention: Fast and Memory-Efficient Exact Attention with IO-Awareness", NeurIPS 2022.

[^9]: Candle Documentation, "Getting Started", 2024. https://huggingface.github.io/candle/

[^10]: TensorRT-LLM Documentation, "User Guide", 2024. https://nvidia.github.io/TensorRT-LLM/

[^11]: Hugging Face Text Generation Inference, "Optimization", 2024. https://huggingface.co/docs/text-generation-inference/

[^12]: M. Nagel et al., "A White Paper on Neural Network Quantization", arXiv:2106.08295, 2021.

[^13]: NVIDIA Deep Learning Performance Guide, 2024. https://docs.nvidia.com/deeplearning/performance/

[^14]: Apache TVM Documentation, "Optimizing ML Models", 2024. https://tvm.apache.org/docs/

[^15]: MLIR Documentation, "Transformations", 2024. https://mlir.llvm.org/
