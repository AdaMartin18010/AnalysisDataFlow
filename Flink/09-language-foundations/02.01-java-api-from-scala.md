...
> 所属阶段: Flink/09-language-foundations | 前置依赖: [02.00-flink-scala-api-overview.md](./02.00-flink-scala-api-overview.md), [Flink Java API基础](https://nightlies.apache.org/flink/flink-docs-stable/docs/dev/datastream/overview/) | 形式化等级: L4-L5
