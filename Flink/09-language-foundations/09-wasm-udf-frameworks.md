...
> **所属阶段**: Flink/09-language-foundations | **前置依赖**: [Flink/13-wasm/wasm-streaming.md](../13-wasm/wasm-streaming.md), [Struct/01-foundation/01.02-type-system-hierarchy.md](../../Struct/01-foundation/01.02-type-system-hierarchy.md) | **形式化等级**: L3-L4 | **版本**: Flink 2.0+
