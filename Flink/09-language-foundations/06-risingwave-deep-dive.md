...
> 所属阶段: Flink/09-language-foundations | 前置依赖: [Flink/05-vs-competitors/flink-vs-spark-streaming.md](../05-vs-competitors/flink-vs-spark-streaming.md), [Knowledge/06-frontier/risingwave-deep-dive.md](../../Knowledge/06-frontier/risingwave-deep-dive.md) | 形式化等级: L4 | **版本**: RisingWave 2.0+ / Flink 1.18+
...
#### 4.4.4 与 Flink VECTOR_SEARCH 对比

Flink 2.0 引入的 `VECTOR_SEARCH` 功能与 RisingWave 原生向量索引的对比：

**架构差异**：

| 维度 | Flink VECTOR_SEARCH | RisingWave 向量索引 |
|------|---------------------|---------------------|
...
**Flink VECTOR_SEARCH 示例**：

```sql
-- Flink 2.0 VECTOR_SEARCH 外部集成
