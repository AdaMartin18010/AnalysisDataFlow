...
> **状态**: 混合 — 已发布版本(2.0-2.3) + 前瞻版本(2.4+) | **最后更新**: 2026-04-20
>
> ⚠️ 本文档包含已发布版本信息和前瞻版本规划。已发布部分(2.0-2.3)反映官方发布状态；前瞻部分(2.4+)处于早期讨论阶段，实现细节可能变更。
...
| **2.3.0** | ✅ **已发布** | **2026 Q2** | [下载](https://flink.apache.org/downloads/) | AI Agent预览 |
...
| 2026-04-20 | 2.3.0 | 标记为已发布，同步前瞻标记更新 | Agent |
| 2026-Q2 | 2.3.0 | GA 发布 | Apache Flink |
| 2026-Q4 | 2.4.0 | 预计 GA | 社区讨论 |
...
*本文档由 Flink Release Tracker V2.1 自动生成 | 最后更新: 2026-04-20*
