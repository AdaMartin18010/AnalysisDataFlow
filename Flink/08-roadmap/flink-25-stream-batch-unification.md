...
[^3]: M. Zaharia et al., "Apache Spark: A Unified Engine for Big Data Processing", Communications of the ACM, 59(11), 2016.

[^4]: Apache Flink Documentation, "Streaming Analytics", 2026. https://nightlies.apache.org/flink/flink-docs-stable/docs/learn-flink/streaming_analytics/

[^5]: R. Chaiken et al., "SCOPE: Easy and Efficient Parallel Processing of Massive Data Sets", PVLDB, 1(2), 2008.

[^6]: K. M. Chandy and L. Lamport, "Distributed Snapshots: Determining Global States of Distributed Systems", ACM Transactions on Computer Systems, 3(1), 1985.

[^7]: Apache Iceberg Documentation, "Table Spec", 2026. https://iceberg.apache.org/spec/

[^8]: Delta Lake Documentation, "Delta Lake Core", 2026. https://docs.delta.io/latest/index.html

[^9]: Apache Paimon Documentation, "Streaming Lakehouse", 2026. https://paimon.apache.org/docs/master/

[^10]: Jay Kreps, "Questioning the Lambda Architecture", O'Reilly Radar, 2014.
