...
>
> **状态更新**: 2026-04-21 — Flink 2.1 已于 2025-07-31 正式发布
>
> 本文档基于 Apache Flink 2.1 官方发布说明整理。内容反映已发布版本的实现，生产环境选型请以 Apache Flink 官方文档为准。
>
...
> **文档类型**: 技术路线图/前沿追踪 | **覆盖版本**: Flink 2.1.x | **状态**: ✅ 已发布
>
> Flink 2.1 已于 2025-07-31 正式发布。本文档基于官方发布说明整理。
