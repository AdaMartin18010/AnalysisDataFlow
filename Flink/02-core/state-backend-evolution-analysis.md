...
[^2]: Apache Flink Documentation, "RocksDB State Backend", 2025. <https://nightlies.apache.org/flink/flink-docs-stable/docs/ops/state/state_backends/#the-embeddedrocksdbstatebackend>

[^3]: Facebook RocksDB Wiki, "RocksDB Basics", <https://github.com/facebook/rocksdb/wiki/RocksDB-Basics>

[^4]: Apache Flink Blog, "Apache Flink 2.0.0 Release Announcement", March 2025. <https://flink.apache.org/2025/03/24/apache-flink-2.0.0-a-new-era-of-real-time-data-processing/>

[^5]: Apache Flink FLIP-320, "Disaggregated State Storage", 2024. <https://cwiki.apache.org/confluence/display/FLINK/FLIP-320>

[^6]: D. Abadi et al., "The Seattle Report on Database Research," *ACM SIGMOD Record*, 2024.
