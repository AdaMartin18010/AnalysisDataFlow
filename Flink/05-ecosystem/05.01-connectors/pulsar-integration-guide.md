...
> 所属阶段: Flink/Connectors | 前置依赖: [Flink-01-04 连接器基础](flink-connectors-ecosystem-complete-guide.md), [Flink-03-01 状态管理](Flink/02-core/flink-state-management-complete-guide.md) | 形式化等级: L3-L4
