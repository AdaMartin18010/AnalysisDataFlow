...
> **所属阶段**: Flink/04-connectors/ | **前置依赖**: [Flink/14-lakehouse/flink-paimon-integration.md](../14-lakehouse/flink-paimon-integration.md), [Flink/02-core-mechanisms/checkpoint-mechanism-deep-dive.md](../02-core-mechanisms/checkpoint-mechanism-deep-dive.md) | **形式化等级**: L4-L5 | **版本**: Flink 1.18+ | Paimon 0.8+
