...
> **所属阶段**: Flink/04-connectors | **前置依赖**: [04.04-cdc-debezium-integration.md](./04.04-cdc-debezium-integration.md), [../14-lakehouse/streaming-lakehouse-architecture.md](../14-lakehouse/streaming-lakehouse-architecture.md) | **形式化等级**: L4-L5 | **版本**: Flink 1.17+, Delta Lake 3.0+
