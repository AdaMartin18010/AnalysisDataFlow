...
- [Flink Dynamic Iceberg Sink 完整指南](#flink-dynamic-iceberg-sink-完整指南)
  ...
  - [7. 可视化 (Visualizations)](#7-可视化-visualizations)
    ...
    - [7.6 Flink Dynamic Iceberg Sink 思维导图](#76-flink-dynamic-iceberg-sink-思维导图)
    - [7.7 多维关联树：特性 → 配置 → 收益](#77-多维关联树特性--配置--收益)
    - [7.8 Iceberg Sink 模式选型决策树](#78-iceberg-sink-模式选型决策树)
