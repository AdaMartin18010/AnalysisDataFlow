...
> 所属阶段: Flink | 前置依赖: [Flink部署架构](Flink/01-concepts/deployment-architectures.md), [Flink UDF扩展](Flink/03-api/09-language-foundations/flink-25-wasm-udf-ga.md) | 形式化等级: L3
