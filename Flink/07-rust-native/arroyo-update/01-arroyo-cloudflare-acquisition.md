...
> 所属阶段: Flink/ | 前置依赖: [13.1-dataflow-model.md](../../09-language-foundations/09-wasm-udf-frameworks.md), [14.1-risingwave-comparison.md](../risingwave-rust-udf-native-guide.md) | 形式化等级: L4-L5
