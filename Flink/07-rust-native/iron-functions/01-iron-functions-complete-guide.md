...
> **所属阶段**: Flink | **前置依赖**: [Flink DataStream API](../../../09-language-foundations/flink-datastream-api-complete-guide.md), [Flink Table/SQL API](../../../03-sql-table-api/flink-table-sql-complete-guide.md) | **形式化等级**: L4
>
