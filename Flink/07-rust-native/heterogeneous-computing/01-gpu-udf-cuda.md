...
> 所属阶段: Flink/14-rust-assembly-ecosystem/heterogeneous-computing | 前置依赖: [Flink UDF 基础](../../09-language-foundations/flink-datastream-api-complete-guide.md), [Rust FFI 绑定](../../09-language-foundations/) | 形式化等级: L4 (工程实践)
