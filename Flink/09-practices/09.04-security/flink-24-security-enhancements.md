...
tls_configuration:
  - [x] 启用 TLS 1.3 (security.ssl.protocol: TLSv1.3)
  - [x] 配置强密码套件 (AES-256-GCM 或 ChaCha20-Poly1305)
  - [x] 禁用 TLS 1.0/1.1/1.2
  - [x] 启用 mTLS (security.ssl.rest.client-auth: REQUIRE)
  - [x] 配置证书热加载
  - [x] 启用 OCSP Stapling
  - [x] 配置会话恢复 (0-RTT 谨慎启用)
