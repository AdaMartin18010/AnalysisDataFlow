...
> **所属阶段**: Flink AI/ML 扩展 | **前置依赖**: [Flink SQL 高级特性](Flink/03-api/03.02-table-sql-api/built-in-functions-complete-list.md), [Flink ML 基础](./flink-ml-architecture.md) | **形式化等级**: L3 (工程实现)
