...
[^3]: Shinn et al., "Reflexion: Self-Reflective Agents", NeurIPS 2023.

[^4]: Wu et al., "AutoGen: Enabling Next-Gen LLM Applications via Multi-Agent Conversation", Microsoft Research, 2023.

[^5]: Anthropic, "Model Context Protocol Specification", 2024.

[^6]: Google, "A2A (Agent-to-Agent) Protocol", 2025.
