...
> 所属阶段: Flink/roadmap | 前置依赖: [FLIP-318][^1] | 形式化等级: L4

## 1. 概念定义 (Definitions)

### Def-F-24-03: Serverless Flink
...
### Def-F-24-04: Serverless Autoscaling
自动扩缩容策略定义为：
$$
