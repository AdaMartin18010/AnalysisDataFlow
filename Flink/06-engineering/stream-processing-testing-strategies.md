...
> 所属阶段: Flink/Engineering | 前置依赖: [Flink/05-fault-tolerance/checkpoint-mechanism.md](../05-fault-tolerance/checkpoint-mechanism.md), [Flink/04-state-management/state-backends.md](../04-state-management/state-backends.md) | 形式化等级: L3
...
[^2]: Apache Flink Documentation, "Unit Testing State And Time", 2025. https://nightlies.apache.org/flink/flink-docs-stable/docs/dev/datastream/testing/#unit-testing-state-and-time

[^3]: Apache Kafka Documentation, "Kafka Streams Testing", 2025. https://kafka.apache.org/documentation/streams/developer-guide/testing.html

[^4]: TestContainers Project, "TestContainers for Java", 2025. https://www.testcontainers.org/
...
[^7]: JUnit-Quickcheck, "Property-based testing for JUnit", GitHub. https://github.com/pholser/junit-quickcheck

[^8]: Netflix Chaos Monkey, "Chaos Engineering", GitHub. https://github.com/Netflix/chaosmonkey

[^9]: Flink ML, "Testing Machine Learning Pipelines in Flink", Apache Flink Blog, 2023.

[^10]: Apache Beam, "Testing I/O Transforms", Beam Documentation. https://beam.apache.org/documentation/io/testing/
