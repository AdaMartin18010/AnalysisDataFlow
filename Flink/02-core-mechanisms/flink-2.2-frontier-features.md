...
> **所属阶段**: Flink/02-core-mechanisms | **前置依赖**: [Flink 2.1 Delta Join](delta-join.md), [物化表](../03-sql-table-api/materialized-tables.md), [向量搜索](../03-sql-table-api/vector-search.md) | **形式化等级**: L4
...
[^11]: Apache Flink FLIP-540, "Support VECTOR_SEARCH in Flink SQL", 2025. https://cwiki.apache.org/confluence/display/FLINK/FLIP-540

[^12]: Apache Flink FLIP-542, "Make materialized table DDL consistent with regular tables", 2025. https://cwiki.apache.org/confluence/display/FLINK/FLIP-542

[^13]: Apache Flink FLIP-544, "SinkUpsertMaterializer V2", 2025. https://cwiki.apache.org/confluence/display/FLINK/FLIP-544

[^14]: Apache Flink FLIP-370, "Support Balanced Tasks Scheduling", 2023. https://cwiki.apache.org/confluence/display/FLINK/FLIP-370
