...
> **所属阶段**: Flink/ 工程实践 | **前置依赖**: [Flink/09-language-foundations/pyflink-complete-guide.md](03-api/09-language-foundations/pyflink-complete-guide.md), [Flink/02-core-mechanisms/checkpoint-mechanism-deep-dive.md](02-core/checkpoint-mechanism-deep-dive.md) | **形式化等级**: L3-L4
