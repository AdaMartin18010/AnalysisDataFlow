...
> **所属阶段**: Flink/03-sql-table-api | **前置依赖**: [flink-cep-complete-guide.md](./03-sql-table-api/flink-cep-complete-guide.md), [time-semantics-and-watermark.md](./02-core-mechanisms/time-semantics-and-watermark.md) | **形式化等级**: L3-L4
