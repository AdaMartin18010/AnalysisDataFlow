...
> 所属阶段: Flink/12-ai-ml | 前置依赖: [checkpoint-mechanism-deep-dive.md](../02-core-mechanisms/checkpoint-mechanism-deep-dive.md), [state-backend-selection.md](../06-engineering/state-backend-selection.md) | 形式化等级: L4
