...
> 所属阶段: TECH-STACK-POSTGRESQL-18-MULTI-LANGUAGE-STREAMING | 前置依赖: [05.05-production-patterns-comparison](../05-production-patterns/05.05-production-patterns-comparison.md), [02.02-postgresql-18-deep-dive](../../02-component-deep-dive/02.02-postgresql-18-deep-dive.md), [03.03-rust-stream-processing](../../03-integration/03.03-rust-stream-processing.md) | 形式化等级: L4
...
[^1]: ISO 10896-1:1995, "Mechanical vibration — Evaluation of machine vibration by measurements on non-rotating parts — Part 1: General guidelines", ISO, 1995.

[^2]: Jardine, A.K.S., Lin, D. and Banjevic, D., "A review on machinery diagnostics and prognostics implementing condition-based maintenance", *Mechanical Systems and Signal Processing*, 20(7), pp.1483–1510, 2006. https://doi.org/10.1016/j.ymssp.2005.09.012

[^3]: Lei, Y., et al., "Machinery health prognostics: A systematic review from data acquisition to RUL prediction", *Mechanical Systems and Signal Processing*, 104, pp.799–834, 2018. https://doi.org/10.1016/j.ymssp.2017.11.016

[^4]: Apache Flink Documentation, "Streaming Analytics for IoT: Predictive Maintenance Patterns", 2025. https://nightlies.apache.org/flink/flink-docs-stable/docs/learn-flink/streaming_analytics/

[^5]: PostgreSQL Global Development Group, "PostgreSQL 18 Documentation — Chapter 5.11: Table Partitioning", 2025. https://www.postgresql.org/docs/18/ddl-partitioning.html

[^6]: RisingWave Labs, "Materialized Views in RisingWave: Incremental Computation for Streaming Data", RisingWave Documentation, 2025. https://docs.risingwave.com/docs/current/materialized-views/

[^7]: Bytewax, "Building ML Pipelines on Streaming Data", Bytewax Documentation, 2025. https://bytewax.io/docs/

[^8]: IEC 62264-1:2013, "Enterprise-control system integration — Part 1: Models and terminology", IEC, 2013.（Purdue模型参考）
