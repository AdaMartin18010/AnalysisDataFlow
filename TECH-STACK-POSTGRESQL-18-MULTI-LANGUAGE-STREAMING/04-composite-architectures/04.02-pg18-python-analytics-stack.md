...
> **🌿 精益优先提示**: Python 分析栈的终极精益形态 = PG18 + RisingWave + pandas。无需 Bytewax/Quix/Kafka。RisingWave 物化视图自动刷新，pandas 直接查询。详见 [04.05-精益架构](../04-composite-architectures/04.05-pg18-lean-architecture.md) 与 [01.05-组件完备性分析](../01-theory-foundation/01.05-architectural-component-completeness.md)。
