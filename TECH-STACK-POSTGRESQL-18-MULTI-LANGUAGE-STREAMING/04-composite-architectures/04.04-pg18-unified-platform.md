...
| **流处理层** | 实时计算、窗口聚合、CEP | Flink、RisingWave、Bytewax、Pathway | SQL/Python/Go |
| **服务层** | API、查询、推送 | REST、gRPC、GraphQL、WebSocket | 所有语言 |
| **治理层** | 监控、安全、配额 | Prometheus、OAuth、RBAC | 所有语言 |
| **部署层** | K8s、Serverless、边缘 | Helm、Knative、Cloudflare Workers | 运行时相关 |
