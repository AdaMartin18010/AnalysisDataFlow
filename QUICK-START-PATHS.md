...
- [快速开始路径](#快速开始路径)
  - [📋 目录](#-目录)
  - [🔰 新用户旅程 (30分钟)](#-新用户旅程-30分钟)
    - [Step 1: 理解流计算 (5分钟)](#step-1-理解流计算-5分钟)
    - [Step 2: 了解项目结构 (5分钟)](#step-2-了解项目结构-5分钟)
    - [Step 3: 选择你的路径 (10分钟)](#step-3-选择你的路径-10分钟)
    - [Step 4: 深入一篇核心文档 (10分钟)](#step-4-深入一篇核心文档-10分钟)
  - [🎯 专家快速参考](#-专家快速参考)
    - [⚡ 5秒定位法](#-5秒定位法)
    - [📚 按需求快速跳转](#-按需求快速跳转)
      - [查找特定模式](#查找特定模式)
