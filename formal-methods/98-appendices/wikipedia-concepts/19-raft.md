...
[^1]: D. Ongaro and J. Ousterhout, "In Search of an Understandable Consensus Algorithm," in *USENIX ATC*, 2014, pp. 305-319. https://raft.github.io/raft.pdf
...
[^3]: L. Lamport, "The Part-Time Parliament," *ACM TOCS*, 16(2), 1998, pp. 133-169. (Paxos 原始论文)

[^4]: L. Lamport, "Paxos Made Simple," *ACM SIGACT News*, 32(4), 2001, pp. 18-25.

[^5]: Raft 可视化演示 (The Secret Lives of Data), http://thesecretlivesofdata.com/raft/

[^6]: Raft 一致性算法官方网站, https://raft.github.io/

[^7]: etcd 文档 - Raft 实现, https://etcd.io/docs/v3.5/learning/design-learner/

[^8]: C. Copeland and H. Zhong, "Tangaroa: a Byzantine Fault Tolerant Raft," 2014. (Byzantine Raft)

[^9]: P. Hunt et al., "ZooKeeper: Wait-free coordination for Internet-scale systems," in *USENIX ATC*, 2010. (对比的协调服务)

[^10]: M. Burrows, "The Chubby lock service for loosely-coupled distributed systems," in *OSDI*, 2006.

[^11]: F. Schneider, "Implementing fault-tolerant services using the state machine approach: a tutorial," *ACM Computing Surveys*, 22(4), 1990, pp. 299-319.

[^12]: R. Van Renesse and D. Altinbuken, "Paxos Made Moderately Complex," *ACM Computing Surveys*, 47(3), 2015, pp. 1-36.
