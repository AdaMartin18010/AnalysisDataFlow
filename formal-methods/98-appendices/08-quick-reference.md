...
- [形式化方法快速参考手册](#形式化方法快速参考手册)
  ...
  - [1. 符号速查表](#1-符号速查表)
    ...
    - [1.5 进程演算符号 (Process Algebra Symbols)](#15-进程演算符号-process-algebra-symbols)
  - [2. 定理编号速查](#2-定理编号速查)
...
### 1.5 进程演算符号 (Process Algebra Symbols)
...
| Thm-F-02-02 | 互模拟=同态核 | 02-category-theory.md | 等价验证 |
| Thm-F-03-01 | LTL模型检测复杂度 | 03-logic-foundations.md | 模型检测 |
...
| Thm-V-02-01 | 符号模型检测正确性 | 02-symbolic-mc.md | 模型检测 |
...
| 6 | **Thm-S-98-04: 强同余定理** | ⭐⭐⭐⭐ | 进程演算等价验证 |
| 7 | **Thm-A-01-01: 工作流网Soundness** | ⭐⭐⭐⭐ | 业务流程验证 |
| 8 | **Thm-F-03-01: LTL模型检测复杂度** | ⭐⭐⭐⭐ | 模型检测可行性分析 |
| 9 | **Thm-F-02-02: 互模拟=同态核** | ⭐⭐⭐ | 余代数验证方法 |
...
│ Kleene: 不动点定理                │                                     │
│ Bisimulation: 行为等价            │ 模型检测: LTL = PSPACE, CTL = P     │
├───────────────────────────────────┴─────────────────────────────────────┤
│ 公式模板                                                               │
├────────────────────────────────────────────────────────────────────────┤
│ Hoare: {P} C {Q}                                                      │
