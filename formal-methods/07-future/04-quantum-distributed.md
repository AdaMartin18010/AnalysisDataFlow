...
**Def-F-07-04-02** (量子进程演算). 量子进程演算(QPA, Quantum Process Algebra)是扩展经典进程演算以支持量子通信和量子计算的代数框架：
...
| 研究方向 | 代表性工作 | 核心贡献 | 发表 |
|---------|-----------|---------|------|
| 量子进程演算 | qCCS扩展[^2] | 支持量子信道噪声建模 | CONCUR 2024 |
...
2. **噪声建模**: 如何在量子进程演算中精确建模现实量子信道的噪声和退相干？
