...
### Def-FM-02-04-01. λ-演算编码 (λ-Calculus Encoding)
...
### Def-FM-02-04-02. 高阶进程编码 (Higher-Order Process Encoding)
...
### Def-FM-02-04-03. 对象编码 (Object Encoding)
...
### Def-FM-02-04-04. 并发数据结构编码 (Concurrent Data Structure Encoding)
