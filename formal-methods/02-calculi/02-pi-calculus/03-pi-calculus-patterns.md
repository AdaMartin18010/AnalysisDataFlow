...
### Def-FM-02-03-01. 请求-响应模式 (Request-Reply Pattern)
...
### Def-FM-02-03-02. 发布-订阅模式 (Publish-Subscribe Pattern)
...
### Def-FM-02-03-03. 管道模式 (Pipeline Pattern)
...
### Def-FM-02-03-04. 负载均衡模式 (Load Balancer Pattern)
...
### Lemma-FM-02-03-01. 请求-响应模式的顺序保证
...
### Lemma-FM-02-03-02. 发布-订阅模式的多播正确性
...
**修复**: 使用名字传递创建私有响应通道（见Def-FM-02-03-01）。
