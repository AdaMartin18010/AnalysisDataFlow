...
| 单元 | 主题数 | 文件数 | 状态 |
|------|--------|--------|------|
| 01-foundations | 3 | 3 | 📝 待完善 |
| 02-calculi | 3 | 9 | 📝 待完善 |
| 03-model-taxonomy | 5 | 14 | 📝 待完善 |
| 04-application-layer | 3 | 9 | 📝 待完善 |
| 05-verification | 3 | 7 | 📝 待完善 |
| 06-tools | 2 | 7 | 📝 待完善 |
| 07-future | 2 | 2 | 📝 待完善 |
| **总计** | **21** | **51** | 🚧 建设中 |
...
| 阶段 | 时间 | 目标 | 状态 |
|------|------|------|------|
| Phase 1 | 2026-04 | 完成基础框架搭建 | 🚧 进行中 |
| Phase 2 | 2026-05 | 填充核心内容（02-calculi, 04-application-layer） | ⏳ 待开始 |
| Phase 3 | 2026-06 | 完善工具链与案例（06-tools） | ⏳ 待开始 |
| Phase 4 | 2026-07 | 对齐权威内容，引入外部资源 | ⏳ 待开始 |
