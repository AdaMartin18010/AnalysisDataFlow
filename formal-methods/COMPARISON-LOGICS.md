...
**定义 Def-FM-CL-04** [霍尔逻辑 Hoare Logic]:
...
**定义 Def-FM-CL-05** [分离逻辑 Separation Logic]:
...
**命题 Prop-FM-CL-02** [CTL到树自动机]:
CTL模型检验等价于交替Büchi树自动机的空性检测。
...
**定理 Thm-FM-CL-03** [CTL*模型检验复杂度]:
CTL*模型检验是2EXPTIME完全的。

### 5.2 证明器完备性

**定理 Thm-FM-CL-04** [霍尔逻辑相对完备性]:
