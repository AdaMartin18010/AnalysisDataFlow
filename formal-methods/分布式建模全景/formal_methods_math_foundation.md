...
- **进程演算 → 逻辑**：Hennessy-Milner 逻辑刻画互模拟
- **进程演算 → 范畴论**：进程作为对象，模拟作为态射
...
| 一阶逻辑 | 范畴论 | 超积构造与极限 |
| 时序逻辑 | 不动点 | $\mu$-演算 |
| 进程演算 | 逻辑 | Hennessy-Milner 逻辑 |
| 进程演算 | 范畴论 | 进程作为对象，模拟作为态射 |
| 格论 | 不动点 | Tarski/Kleene 定理 |
| 格论 | 类型论 | 域语义 |
| 范畴论 | 类型论 | CCC 与简单类型λ演算 |
| 范畴论 | 代数 | 泛代数与代数理论 |
| 类型论 | 逻辑 | Curry-Howard 同构 |
| 类型论 | 范畴论 | 笛卡尔闭范畴 |
