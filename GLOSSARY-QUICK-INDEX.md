# 术语快速查找索引 (Glossary Quick Index)

> **版本**: v1.0 | **更新日期**: 2026-04-04 | **术语总数**: 190+
>
> **🔍 搜索标签**: #Glossary #术语 #Terminology #QuickLookup #索引 #词汇表
...
| 一致性层级 | Consistency Hierarchy | 一致性 | [详细定义](GLOSSARY.md#consistency-model-一致性模型) |
| 因果一致性 | Causal Consistency | 一致性 | [详细定义](GLOSSARY.md#causal-consistency-因果一致性) |
| 最终一致性 | Eventual Consistency | 一致性 | [详细定义](GLOSSARY.md#eventual-consistency-最终一致性) |
| CALM定理 | CALM Theorem | 理论 | [详细定义](GLOSSARY.md#calm-theorem-calm-定理) |
...
| 术语 | 定义概要 | 文档链接 |
|------|----------|----------|
| Backpressure | 下游处理慢时向上游传递的流控信号 | [GLOSSARY.md](GLOSSARY.md#backpressure-反压) |
| Barrier | Checkpoint分隔数据流的控制消息 | [GLOSSARY.md](GLOSSARY.md#barrier-checkpoint-barrier) |
| Batch Processing | 处理有限数据集的计算模式 | [GLOSSARY.md](GLOSSARY.md#batch-processing-批处理) |
| Best-Effort | 不提供一致性保证的交付语义 | [GLOSSARY.md](GLOSSARY.md#best-effort-尽力而为) |
| Bisimulation | 进程代数中判断行为等价的关系 | [GLOSSARY.md](GLOSSARY.md#bisimulation-互模拟) |
| Bounded Stream | 有限数据量的数据流 | [GLOSSARY.md](GLOSSARY.md#bounded-stream-有界流) |

### C

| 术语 | 定义概要 | 文档链接 |
|------|----------|----------|
| CALM Theorem | 逻辑单调程序无需协调即可保证一致性 | [GLOSSARY.md](GLOSSARY.md#calm-theorem-calm-定理) |
| Causal Consistency | 保留因果依赖关系的一致性模型 | [GLOSSARY.md](GLOSSARY.md#causal-consistency-因果一致性) |
| CEP | 从事件流中检测复杂模式的技术 | [GLOSSARY.md](GLOSSARY.md#cep-complex-event-processing-复杂事件处理) |
| CCS | Milner提出的基于标签化同步的进程代数 | [GLOSSARY.md](GLOSSARY.md#ccs-calculus-of-communicating-systems) |
| CDC | 捕获数据库变更事件的技术 | [GLOSSARY.md](GLOSSARY.md#cdc-change-data-capture-变更数据捕获) |
| Checkpoint | 分布式流处理作业的全局一致状态快照 | [GLOSSARY.md](GLOSSARY.md#checkpoint-检查点) |
| Chandy-Lamport | 分布式全局一致快照算法 | [GLOSSARY.md](GLOSSARY.md#chandy-lamport-algorithm) |
| Cloud-Native | 利用云计算优势构建应用的方法论 | [GLOSSARY.md](GLOSSARY.md#cloud-native-云原生) |
| Consistency Model | 定义数据操作可见性和顺序性的规则 | [GLOSSARY.md](GLOSSARY.md#consistency-model-一致性模型) |
| Credit-Based Flow Control | 基于信用值的流量控制机制 | [GLOSSARY.md](GLOSSARY.md#credit-based-flow-control-基于信用的流控) |
...
| 术语 | 定义概要 | 文档链接 |
|------|----------|----------|
| Global Snapshot | 分布式系统全局状态快照 | [GLOSSARY.md](GLOSSARY.md#global-snapshot-全局快照) |
| JobManager | Flink作业管理器 | [GLOSSARY.md](GLOSSARY.md#jobmanager) |
| Lakehouse | 湖仓一体架构 | [GLOSSARY.md](GLOSSARY.md#lakehouse-湖仓一体) |
| Latency | 延迟 | [GLOSSARY.md](GLOSSARY.md#latency-延迟) |
...
| 术语 | 定义概要 | 文档链接 |
|------|----------|----------|
| RAG | 检索增强生成 | [GLOSSARY.md](GLOSSARY.md#rag-retrieval-augmented-generation) |
| RocksDB | 嵌入式KV存储，Flink状态后端 | [GLOSSARY.md](GLOSSARY.md#rocksdb) |
...
- [完整术语表 (GLOSSARY.md)](GLOSSARY.md) - 包含详细定义、形式化描述和参考文档
- [Flink/00-INDEX.md](Flink/00-INDEX.md) - Flink专项文档索引
- [Struct/00-INDEX.md](Struct/00-INDEX.md) - 形式理论文档索引
- [Knowledge/00-INDEX.md](Knowledge/00-INDEX.md) - 工程知识文档索引

---

*术语快速查找索引 v1.0 | 更新时间: 2026-04-04 | 完整术语表: [GLOSSARY.md](GLOSSARY.md)*
