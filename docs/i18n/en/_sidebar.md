# AnalysisDataFlow English Documentation
...
### [Struct/ - Formal Theory](01-STRUCT-GUIDE.md)

- 01-foundation/ - Basic Theory
- 02-properties/ - Property Derivation
- 03-relationships/ - Relationship Building
- 04-proofs/ - Formal Proofs
- 05-comparative-analysis/ - Comparative Analysis
- 06-frontier/ - Frontier Research
- 07-tools/ - Tool Practice
- 08-standards/ - Standards

### [Knowledge/ - Engineering Knowledge](02-KNOWLEDGE-GUIDE.md)

- 01-concept-atlas/ - Concept Atlas
- 02-design-patterns/ - Design Patterns
- 03-business-patterns/ - Business Scenarios
- 04-technology-selection/ - Technology Selection
- 05-mapping-guides/ - Mapping Guides
- 06-frontier/ - Frontier Exploration
- 07-best-practices/ - Best Practices
- 08-standards/ - Standards
- 09-anti-patterns/ - Anti-Patterns

### [Flink/ - Flink-Specific Technology](03-FLINK-GUIDE.md)

- 01-architecture/ - Architecture Design
- 02-core-mechanisms/ - Core Mechanisms
- 03-sql-table-api/ - SQL & Table API
- 04-connectors/ - Connector Ecosystem
- 05-vs-competitors/ - Competitor Comparison
- 06-engineering/ - Engineering Practices
- 07-case-studies/ - Case Studies
- 08-roadmap/ - Roadmaps
- 09-language-foundations/ - Multi-language
...
- **Total Documents**: 420+
- **Formal Elements**: 6,263+
- **Mermaid Diagrams**: 1,774+
- **Code Examples**: 7,118+
