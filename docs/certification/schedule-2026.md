...
- [x] 完成 [课程大纲](./csa/syllabus-csa.md) 全部模块
- [x] 完成 [练习题库](./csa/quizzes/) 至少 200 题
- [x] 完成 1 套模拟考试（正确率 75%+）
- [x] 准备好带摄像头的电脑
- [x] 测试网络连接
...
- [x] 完成 [课程大纲](./csp/syllabus-csp.md) 全部模块
- [x] 完成所有实验任务
- [x] 完成 [练习题库](./csp/quizzes/) 至少 300 题
- [x] 申请实验环境进行练习
- [x] 熟悉 K8s 基本操作

### CSE 考前准备

- [x] 完成 [课程大纲](./cse/syllabus-cse.md) 学习
- [x] 确定研究选题
- [x] 阅读形式化理论经典文献
- [x] 准备资质证明材料
