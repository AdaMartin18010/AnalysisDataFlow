...
- [定理证明指南](#定理证明指南)
  ...
  - [1. Coq入门指南](#1-coq入门指南)
    - [1.1 安装与配置](#11-安装与配置)
    - [1.2 基础语法](#12-基础语法)
    - [1.3 流计算专用库](#13-流计算专用库)
    - [1.4 核心概念映射](#14-核心概念映射)
    - [1.5 证明Exactly-Once语义](#15-证明exactly-once语义)
  - [2. TLA+建模指南](#2-tla建模指南)
    - [2.1 安装与配置](#21-安装与配置)
    - [2.2 基础模块结构](#22-基础模块结构)
    - [2.3 流系统建模模式](#23-流系统建模模式)
    - [2.4 一致性验证](#24-一致性验证)
    - [2.5 Checkpoint建模](#25-checkpoint建模)
  - [3. 证明策略手册](#3-证明策略手册)
    - [3.1 Coq证明策略](#31-coq证明策略)
      - [基础策略](#基础策略)
      - [高级策略](#高级策略)
    - [3.2 TLA+证明策略](#32-tla证明策略)
      - [不变量证明](#不变量证明)
      - [活性证明](#活性证明)
    - [3.3 流计算专用策略](#33-流计算专用策略)
      - [Watermark单调性证明](#watermark单调性证明)
      - [Checkpoint一致性证明](#checkpoint一致性证明)
  - [4. 常见证明模式](#4-常见证明模式)
    - [4.1 结构归纳法](#41-结构归纳法)
    - [4.2 互模拟证明](#42-互模拟证明)
    - [4.3 安全性与活性组合](#43-安全性与活性组合)
    - [4.4 容错证明模式](#44-容错证明模式)
  - [5. 自动化工具链](#5-自动化工具链)
    - [5.1 定理证明自动化脚本](#51-定理证明自动化脚本)
