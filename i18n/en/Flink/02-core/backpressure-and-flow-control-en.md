...
- [Backpressure and Flow Control](#backpressure-and-flow-control)
  ...
  - [3. Relations](#3-relations)
    - [Relation 1: Flink CBFC `⊃` TCP Flow Control](#relation-1-flink-cbfc-supset-tcp-flow-control)
    - [Relation 2: Local Backpressure `→` End-to-End Backpressure](#relation-2-local-backpressure-to-end-to-end-backpressure)
    - [Relation 3: Backpressure `↔` Checkpoint Reliability](#relation-3-backpressure-leftrightarrow-checkpoint-reliability)
