...
- [AnalysisDataFlow 部署架构图集](#analysisdataflow-部署架构图集)
  - [目录](#目录)
  - [1. 本地开发部署](#1-本地开发部署)
    - [1.1 单机部署架构](#11-单机部署架构)
    - [1.2 开发环境配置](#12-开发环境配置)
    - [1.3 本地测试架构](#13-本地测试架构)
  - [2. 生产集群部署](#2-生产集群部署)
    - [2.1 高可用架构](#21-高可用架构)
    - [2.2 负载均衡架构](#22-负载均衡架构)
    - [2.3 故障恢复架构](#23-故障恢复架构)
  - [3. 云原生部署](#3-云原生部署)
    - [3.1 K8s部署架构](#31-k8s部署架构)
    - [3.2 Serverless部署](#32-serverless部署)
    - [3.3 混合云部署](#33-混合云部署)
  - [4. 边缘部署](#4-边缘部署)
    - [4.1 边缘计算架构](#41-边缘计算架构)
    - [4.2 云边协同架构](#42-云边协同架构)
    - [4.3 离线处理架构](#43-离线处理架构)
  - [5. 特殊场景部署](#5-特殊场景部署)
    - [5.1 金融级高可用](#51-金融级高可用)
    - [5.2 IoT大规模部署](#52-iot大规模部署)
    - [5.3 实时分析专用部署](#53-实时分析专用部署)
  - [附录](#附录)
    - [A. 架构选型决策树](#a-架构选型决策树)
    - [B. 部署检查清单](#b-部署检查清单)
      - [生产环境检查项](#生产环境检查项)
