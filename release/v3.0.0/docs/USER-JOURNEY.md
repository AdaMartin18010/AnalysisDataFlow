...
| P1 | [一致性层级](Struct/02-properties/02.02-consistency-hierarchy.md) | 2-3h | 掌握一致性模型选择 |
...
| P0 | [Actor 模型形式化](Struct/01-foundation/01.03-actor-model-formalization.md) | 4-6h | 理解 Actor 语义 |
