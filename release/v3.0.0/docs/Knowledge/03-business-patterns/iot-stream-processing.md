...
- [业务模式: IoT 物联网流处理 (Business Pattern: IoT Stream Processing)](#业务模式-iot-物联网流处理-business-pattern-iot-stream-processing)
  ...
  - [7. 可视化 (Visualizations)](#7-可视化-visualizations)
    ...
    - [7.2 Actor + Dataflow 双层架构 {#72-actor--dataflow-双层架构} {#72-actor--dataflow-双层架构-72-actor--dataflow-双层架构}](#72-actor--dataflow-双层架构-72-actor--dataflow-双层架构-72-actor--dataflow-双层架构-72-actor--dataflow-双层架构)
