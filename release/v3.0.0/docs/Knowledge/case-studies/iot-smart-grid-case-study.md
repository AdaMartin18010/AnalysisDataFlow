...
> **所属阶段**: Knowledge/case-studies/iot | **前置依赖**: [Knowledge/10-case-studies/iot/10.3.1-smart-meter-data-processing.md](../../10-case-studies/iot/10.3.1-smart-meter-data-processing.md) | **形式化等级**: L5
