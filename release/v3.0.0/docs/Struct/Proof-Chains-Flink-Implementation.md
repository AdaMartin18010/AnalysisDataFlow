...
`Thm-F-02-01` HashMapStateBackend Checkpoint 一致性定理
...
**Thm-F-02-47**: RocksDBStateBackend 一致性定理
...
**Thm-F-02-45**: ForStStateBackend 一致性定理
...
| **一致性定理** | Thm-F-02-01 | Thm-F-02-47 | Thm-F-02-45 |
...
`Thm-F-02-01` (扩展): Checkpoint 恢复一致性定理
...
| 形式化元素 | 实现类 | 包路径 |
|------------|--------|--------|
| Def-F-02-91 | `HashMapStateBackend` | `org.apache.flink.runtime.state.hashmap` |
| Def-F-02-63 | `EmbeddedRocksDBStateBackend` | `org.apache.flink.state.rocksdb` |
| Def-F-02-61 | `ForStStateBackend` | `org.apache.flink.state.forst` |
| Thm-F-02-01 | `CheckpointCoordinator` | `org.apache.flink.runtime.checkpoint` |
| Lemma-F-02-23 | `BarrierHandler` | `org.apache.flink.streaming.runtime.io` |
| Def-F-02-70 | `AsyncFunction` | `org.apache.flink.streaming.api.functions.async` |
| Thm-F-02-50 | `AsyncWaitOperator` | `org.apache.flink.streaming.api.operators` |
| Def-F-02-74 | `OutputMode` | `org.apache.flink.streaming.api.functions.async` |

### 6.2 关键方法实现

**Checkpoint 触发（Thm-F-02-01）**:
