...
- [Watermark 单调性定理 (Watermark Monotonicity Theorem) {#watermark-单调性定理-watermark-monotonicity-theorem}](#watermark-单调性定理-watermark-monotonicity-theorem-watermark-单调性定理-watermark-monotonicity-theorem)
  - [目录](#目录)
  ...
  - [5. 形式证明 / 工程论证 (Proof / Engineering Argument) {#5-形式证明--工程论证-proof--engineering-argument}](#5-形式证明--工程论证-proof--engineering-argument-5-形式证明--工程论证-proof--engineering-argument)
    ...
    - [步骤 3：归纳步骤 — 第 $k$ 个算子的单调性保持 {#步骤-3-归纳步骤--第-k-个算子的单调性保持}](#步骤-3归纳步骤--第-k-个算子的单调性保持-步骤-3-归纳步骤--第-k-个算子的单调性保持)
