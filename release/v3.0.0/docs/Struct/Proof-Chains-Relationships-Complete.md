...
| 定理编号 | 名称 | 状态 | 依赖 |
|---------|------|------|------|
| Thm-S-13-06 | Savepoint编码保持语义 | 📝 待完善 | Def-S-13-04 |
...
**依赖元素**: Def-S-16-01, Def-S-16-02, Def-S-16-03, Def-S-16-04
...
graph TB
    subgraph Foundation["基础层"]
        D0103[Def-S-01-03<br/>Actor语义]
        D0201[Def-S-02-01<br/>π-演算]
        D0501[Def-S-05-01<br/>CSP语法]
    end

    subgraph Properties["性质层"]
        T0701[Thm-S-07-01<br/>确定性]
        T0801[Thm-S-08-01<br/>Exactly-Once]
    end

    subgraph Relationships["关系层"]
        D1201[Def-S-12-01<br/>Actor配置]
        D1203[Def-S-12-03<br/>Actor→CSP编码]
        L1201[Lemma-S-12-01<br/>MAILBOX FIFO]
        T1201[Thm-S-12-01<br/>Actor→CSP保持]

        D1301[Def-S-13-01<br/>Flink→π编码]
        L1301[Lemma-S-13-01<br/>局部确定性]
        T1301[Thm-S-13-01<br/>Flink EO保持]

        D1403[Def-S-14-03<br/>六层层次]
        T1401[Thm-S-14-01<br/>严格层次]

        D1501[Def-S-15-01<br/>强互模拟]
        T1501[Thm-S-15-01<br/>互模拟同余]

        D1601[Def-S-16-01<br/>四层框架]
        T1601[Thm-S-16-01<br/>跨层组合]
    end
...
|---------|---------|-----------|---------|
| Thm-S-12-01 | 5个 | 8个 | 中等 |
| Thm-S-13-01 | 5个 | 10个 | 长 |
| Thm-S-14-01 | 1个 | 3个 | 短 |
| Thm-S-15-01 | 4个 | 6个 | 中等 |
| Thm-S-16-01 | 4个 | 10个 | 长 |
