...
**推论**: π-Calculus的通用性以可判定性为代价（见Thm-S-02-01）。
...
graph TB
    subgraph Foundation["Foundation Layer - 基础定义"]
        D0201[Def-S-02-01<br/>CCS语法语义]
        D0202[Def-S-02-02<br/>CSP语法语义]
        D0203[Def-S-02-03<br/>π-Calculus语法]
        D0204[Def-S-02-04<br/>会话类型]
    end

    subgraph Properties["Properties Layer - 性质引理"]
        L0201[Lemma-S-02-01<br/>静态拓扑不变]
        L0202[Lemma-S-02-02<br/>动态图灵完备]
