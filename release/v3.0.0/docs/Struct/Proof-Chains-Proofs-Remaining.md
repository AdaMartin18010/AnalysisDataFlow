...
**定理陈述** (Thm-S-20-01: Watermark完全格定理)
...
### 2.2 合并算子性质 Thm-S-20-02 ~ Thm-S-20-05

#### Thm-S-20-02: 结合律 (Associativity)
...
```mermaid
graph LR
    D2001[Def-S-20-01<br/>Watermark格元素] --> T2002[Thm-S-20-02<br/>结合律]
    D2001 --> T2003[Thm-S-20-03<br/>交换律]
    D2001 --> T2004[Thm-S-20-04<br/>幂等律]
    T2002 --> T2005[Thm-S-20-05<br/>吸收律]
    T2003 --> T2005
    T2004 --> T2005
    T2005 --> T2001_confirm[Thm-S-20-01<br/>完全格确认]
```

---

### 2.3 传播单调性 Thm-S-20-06 ~ Thm-S-20-08
...
### 2.4 多源流协调 Thm-S-20-09 ~ Thm-S-20-10
...
**定理陈述** (Thm-S-21-01: FG/FGG 类型安全定理)
...
graph TD
    ...
    L2102 --> L2103
    L2103 --> T2101[Thm-S-21-01<br/>类型安全 ✓]
...
### 3.2 FGG 泛型保持 Thm-S-21-02

**定理陈述** (Thm-S-21-02: FGG 泛型实例化保持类型安全)
...
### 3.3 方法解析完备性 Thm-S-21-03 ~ Thm-S-21-05
...
### 3.4 类型替换引理组 Thm-S-21-06 ~ Thm-S-21-10
...
| Thm-S-21-10 | goroutine 类型安全 | go e 保持并发安全 |
...
### 4.2 路径类型良构性 Thm-S-22-02 ~ Thm-S-22-04
...
```mermaid
graph TD
    D2201[Def-S-22-01<br/>DOT抽象语法] --> D2202[Def-S-22-02<br/>路径与路径类型]
    D2202 --> T2202[Thm-S-22-02<br/>路径良构性]
    D2202 --> T2203[Thm-S-22-03<br/>路径等价判定]
    D2202 --> T2204[Thm-S-22-04<br/>路径类型一致性]
    T2202 --> T2201[Thm-S-22-01<br/>子类型完备性]
    T2203 --> T2201
    T2204 --> T2201
```
...
### 4.3 名义vs结构子类型 Thm-S-22-05 ~ Thm-S-22-07
...
### 4.4 递归类型展开 Thm-S-22-08 ~ Thm-S-22-10
...
**定理陈述** (Thm-S-23-01: Choreographic 死锁自由定理)
...
### 5.2 EPP 投影保持 Thm-S-23-02 ~ Thm-S-23-04
...
graph TD
    ...
    T2302 --> T2301[Thm-S-23-01<br/>死锁自由 ✓]
    T2303 --> T2301
    T2304 --> T2301
```
...
### 5.3 全局类型合成 Thm-S-23-05 ~ Thm-S-23-07
...
### 5.4 多角色协调 Thm-S-23-08 ~ Thm-S-23-10
...
### 6.1 Go vs Scala 图灵等价 Thm-S-24-01

**定理陈述** (Thm-S-24-01: Go 与 Scala 图灵完备等价)
...
### 6.2 并发原语表达能力 Thm-S-24-02 ~ Thm-S-24-05
...
#### Thm-S-24-05: Context 传播正确性

**定理**: context 取消信号正确传播到所有派生 goroutine。

---

### 6.3 内存模型精化 Thm-S-24-06 ~ Thm-S-24-10
...
### 6.4 编译正确性 Thm-S-24-11 ~ Thm-S-24-15
...
### 6.5 优化保持性 Thm-S-24-16 ~ Thm-S-24-20
...
*文档生成时间*: 2026-04-11
*定理覆盖*: 60个 (Thm-S-20-01 ~ Thm-S-24-20)
