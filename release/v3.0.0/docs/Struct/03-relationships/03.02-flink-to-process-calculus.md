# Flink 到进程演算编码 (Flink-to-Process Calculus Encoding) {#关系-1-flink-dataflow-图--π-演算进程网络-关系-1-flink-dataflow-图--π-演算进程网络}
...
- [Flink 到进程演算编码 (Flink-to-Process Calculus Encoding) {#关系-1-flink-dataflow-图--π-演算进程网络-关系-1-flink-dataflow-图--π-演算进程网络}](#flink-到进程演算编码-flink-to-process-calculus-encoding-关系-1-flink-dataflow-图--π-演算进程网络-关系-1-flink-dataflow-图--π-演算进程网络)
  - [目录](#目录)
...
### 关系 1: Flink Dataflow 图 `↦` π-演算进程网络
...
### 关系 3: Flink Exactly-Once `↦` π-演算幂等进程组合
