...
- [跨模型统一映射框架 (Cross-Model Unified Mapping Framework)](#跨模型统一映射框架-cross-model-unified-mapping-framework)
  ...
  - [3. 关系建立 (Relations)](#3-关系建立-relations)
    - [3.1 理论层 $\\mathcal{L}_{\\text{theory}}$ 与语言层 $\\mathcal{L}_{\\text{language}}$ 的关系 {#31-理论层-mathcalltexttheory-与语言层-mathcalltextlanguage-的关系}](#31-理论层-mathcalltexttheory-与语言层-mathcalltextlanguage-的关系-31-理论层-mathcalltexttheory-与语言层-mathcalltextlanguage-的关系)
    - [3.2 语言层 $\\mathcal{L}_{\\text{language}}$ 与系统层 $\\mathcal{L}_{\\text{system}}$ 的关系 {#32-语言层-mathcalltextlanguage-与系统层-mathcalltextsystem-的关系}](#32-语言层-mathcalltextlanguage-与系统层-mathcalltextsystem-的关系-32-语言层-mathcalltextlanguage-与系统层-mathcalltextsystem-的关系)
    - [3.3 系统层 $\\mathcal{L}_{\\text{system}}$ 与领域层 $\\mathcal{L}_{\\text{domain}}$ 的关系 {#33-系统层-mathcalltextsystem-与领域层-mathcalltextdomain-的关系}](#33-系统层-mathcalltextsystem-与领域层-mathcalltextdomain-的关系-33-系统层-mathcalltextsystem-与领域层-mathcalltextdomain-的关系)
