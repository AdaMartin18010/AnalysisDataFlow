...
- [AnalysisDataFlow — 综合导航索引](#analysisdataflow--综合导航索引)
  - [📋 目录](#-目录)
  - [1. 快速入口导航](#1-快速入口导航)
    - [1.1 按角色入口](#11-按角色入口)
    - [1.2 按主题入口](#12-按主题入口)
    - [1.3 用户角色导航路径](#13-用户角色导航路径)
      - [学术研究者路径](#学术研究者路径)
      - [工程师路径](#工程师路径)
      - [架构师路径](#架构师路径)
    - [1.4 按问题入口](#14-按问题入口)
  - [2. 可视化文档导航](#2-可视化文档导航)
    - [2.1 决策树导航 (8个)](#21-决策树导航-8个)
    - [2.2 矩阵对比导航 (8个)](#22-矩阵对比导航-8个)
    - [2.3 关系图导航 (8个)](#23-关系图导航-8个)
    - [2.4 综合可视化导航 (8个)](#24-综合可视化导航-8个)
  - [3. 文档类型索引](#3-文档类型索引)
    - [3.1 形式化理论文档索引 (Struct/)](#31-形式化理论文档索引-struct)
      - [基础理论 (01-foundation/)](#基础理论-01-foundation)
      - [性质推导 (02-properties/)](#性质推导-02-properties)
      - [形式证明 (04-proofs/)](#形式证明-04-proofs)
      - [验证工具 (07-tools/)](#验证工具-07-tools)
    - [3.2 工程实践文档索引 (Knowledge/)](#32-工程实践文档索引-knowledge)
      - [设计模式 (02-design-patterns/)](#设计模式-02-design-patterns)
      - [业务场景 (03-business-patterns/)](#业务场景-03-business-patterns)
      - [反模式 (09-anti-patterns/)](#反模式-09-anti-patterns)
    - [3.3 Flink专项文档索引 (Flink/)](#33-flink专项文档索引-flink)
      - [核心机制 (02-core-mechanisms/)](#核心机制-02-core-mechanisms)
      - [SQL与Table API (03-sql-table-api/)](#sql与table-api-03-sql-table-api)
      - [连接器生态 (04-connectors/)](#连接器生态-04-connectors)
      - [部署与运维 (10-deployment/)](#部署与运维-10-deployment)
      - [AI/ML集成 (12-ai-ml/)](#aiml集成-12-ai-ml)
    - [3.4 前沿技术文档索引 (Knowledge/06-frontier/ \& Flink/前沿/)](#34-前沿技术文档索引-knowledge06-frontier--flink前沿)
  - [4. 工具与资源导航](#4-工具与资源导航)
    - [4.1 自动化脚本工具 (.scripts/)](#41-自动化脚本工具-scripts)
    - [4.2 CI/CD 工作流 (.github/workflows/)](#42-cicd-工作流-githubworkflows)
    - [4.3 Docker环境入口](#43-docker环境入口)
    - [4.4 搜索工具入口](#44-搜索工具入口)
    - [4.5 PDF导出入口](#45-pdf导出入口)
  - [5. 学习资源导航](#5-学习资源导航)
    - [5.1 快速上手指南](#51-快速上手指南)
    - [5.2 学习路径引导](#52-学习路径引导)
      - [初学者路径 (2-3周)](#初学者路径-2-3周)
      - [进阶工程师路径 (4-6周)](#进阶工程师路径-4-6周)
      - [架构师路径 (持续)](#架构师路径-持续)
    - [5.3 快速参考卡片](#53-快速参考卡片)
    - [5.4 交互式学习资源](#54-交互式学习资源)
    - [5.5 演示文稿大纲](#55-演示文稿大纲)
  - [6. 维护与贡献导航](#6-维护与贡献导航)
    - [6.1 维护手册](#61-维护手册)
    - [6.2 贡献指南](#62-贡献指南)
    - [6.3 验证报告](#63-验证报告)
    - [6.4 更新日志](#64-更新日志)
  - [附录](#附录)
    - [A. 项目统计 (v3.3 最新)](#a-项目统计-v33-最新)
    - [B. 目录索引快速入口](#b-目录索引快速入口)
    - [C. 外部资源链接](#c-外部资源链接)
    - [D. v3.3路线图关键里程碑](#d-v33路线图关键里程碑)
...
| | | [Flink/00-meta/00-INDEX.md](Flink/00-meta/00-INDEX.md) |
...
| **版本跟踪** | [Flink/00-meta/version-tracking.md](Flink/00-meta/version-tracking.md) | 版本历史、变更记录 |
...
- [Flink/00-meta/00-INDEX.md](Flink/00-meta/00-INDEX.md) — Flink专项完整索引
...
| Flink FLIP提案 | <https://cwiki.apache.org/confluence/display/FLINK/Flink+Improvement+Proposals> |
