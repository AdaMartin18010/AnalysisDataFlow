...
> **前置依赖**: [WebAssembly Component Model](../../03-api/09-language-foundations/09-wasm-udf-frameworks.md), [WASI 0.2 接口规范](../../03-api/09-language-foundations/09-wasm-udf-frameworks.md)
