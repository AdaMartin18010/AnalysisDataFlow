...
- Flink 1.x vs 2.0 对比: [../01-architecture/flink-1.x-vs-2.0-comparison.md](../../../01-concepts/flink-1.x-vs-2.0-comparison.md)
- Checkpoint 机制详解: [../02-core-mechanisms/checkpoint-mechanism-deep-dive.md](../../../02-core/checkpoint-mechanism-deep-dive.md)
