...
> **所属阶段**: Flink/06-engineering | **前置依赖**: [Flink SQL 深度解析](../../03-api/03.02-table-sql-api/flink-sql-calcite-optimizer-deep-dive.md), [Flink-Paimon 集成](../../05-ecosystem/05.01-connectors/flink-paimon-integration.md) | **形式化等级**: L4
