...
[^2]: Apache Flink Documentation, "Streaming SQL: Joins", 2024. https://nightlies.apache.org/flink/flink-docs-stable/docs/dev/table/sql/queries/joins/
[^3]: Kleppmann M., "Designing Data-Intensive Applications", O'Reilly Media, 2017.
[^4]: 某头部 OTA 平台内部技术博客, 《从批处理到流处理：OTA 实时库存架构演进》, 2024.
