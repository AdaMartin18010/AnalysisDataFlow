...
- [Flink IoT 告警与监控体系](#flink-iot-告警与监控体系)
  - [目录](#目录)
  - [1. 概念定义 (Definitions)](#1-概念定义-definitions)
    - [Def-F-IoT-05-01: Metric (指标)](#def-f-iot-05-01-metric-指标)
    - [Def-F-IoT-05-02: Alert (告警)](#def-f-iot-05-02-alert-告警)
    - [Def-F-IoT-05-03: SLO (Service Level Objective)](#def-f-iot-05-03-slo-service-level-objective)
    - [Def-F-IoT-05-04: Dashboard (仪表板)](#def-f-iot-05-04-dashboard-仪表板)
  - [2. 属性推导 (Properties)](#2-属性推导-properties)
    - [Prop-F-IoT-05-01: 监控指标的层次性](#prop-f-iot-05-01-监控指标的层次性)
    - [Prop-F-IoT-05-02: 四大核心指标的完备性](#prop-f-iot-05-02-四大核心指标的完备性)
    - [Prop-F-IoT-05-03: 告警疲劳的数学边界](#prop-f-iot-05-03-告警疲劳的数学边界)
  - [3. 关系建立 (Relations)](#3-关系建立-relations)
    - [3.1 监控体系与Dataflow模型的映射](#31-监控体系与dataflow模型的映射)
    - [3.2 技术栈集成关系](#32-技术栈集成关系)
    - [3.3 AWS CloudWatch 与开源方案对比](#33-aws-cloudwatch-与开源方案对比)
  - [4. 论证过程 (Argumentation)](#4-论证过程-argumentation)
    - [4.1 四大指标详解](#41-四大指标详解)
      - [4.1.1 Event Lag (事件延迟)](#411-event-lag-事件延迟)
      - [4.1.2 Checkpoint Duration (检查点耗时)](#412-checkpoint-duration-检查点耗时)
      - [4.1.3 Device Heartbeat (设备心跳)](#413-device-heartbeat-设备心跳)
      - [4.1.4 Watermark Progress (水印进度)](#414-watermark-progress-水印进度)
    - [4.2 告警规则设计模式](#42-告警规则设计模式)
      - [模式1: 阈值告警 (Threshold Alert)](#模式1-阈值告警-threshold-alert)
      - [模式2: 趋势告警 (Trend Alert)](#模式2-趋势告警-trend-alert)
      - [模式3: 异常检测 (Anomaly Detection)](#模式3-异常检测-anomaly-detection)
  - [5. 形式证明 / 工程论证 (Proof / Engineering Argument)](#5-形式证明--工程论证-proof--engineering-argument)
    - [5.1 Prometheus 集成完整方案](#51-prometheus-集成完整方案)
      - [5.1.1 Flink Metrics Reporter 配置](#511-flink-metrics-reporter-配置)
      - [5.1.2 Prometheus 抓取配置](#512-prometheus-抓取配置)
      - [5.1.3 完整的 Prometheus Alert Rules](#513-完整的-prometheus-alert-rules)
      - [5.1.4 Alertmanager 配置](#514-alertmanager-配置)
  - [6. 实例验证 (Examples)](#6-实例验证-examples)
    - [6.1 Grafana 仪表板配置](#61-grafana-仪表板配置)
      - [6.1.1 Flink集群监控仪表板](#611-flink集群监控仪表板)
      - [6.1.2 IoT设备监控仪表板](#612-iot设备监控仪表板)
      - [6.1.3 告警事件列表面板](#613-告警事件列表面板)
    - [6.2 AWS CloudWatch 集成方案](#62-aws-cloudwatch-集成方案)
      - [6.2.1 CloudWatch Agent 配置](#621-cloudwatch-agent-配置)
      - [6.2.2 CloudWatch 告警配置 (Terraform)](#622-cloudwatch-告警配置-terraform)
      - [6.2.3 AWS CloudWatch Dashboard](#623-aws-cloudwatch-dashboard)
    - [6.3 Flink SQL 告警处理器](#63-flink-sql-告警处理器)
  - [7. 可视化 (Visualizations)](#7-可视化-visualizations)
    - [7.1 IoT监控架构全景图](#71-iot监控架构全景图)
    - [7.2 四大核心指标监控流程](#72-四大核心指标监控流程)
    - [7.3 告警级别决策树](#73-告警级别决策树)
  - [8. 引用参考 (References)](#8-引用参考-references)
  - [附录: 监控指标清单](#附录-监控指标清单)
    - [A.1 Flink内置IoT相关指标](#a1-flink内置iot相关指标)
    - [A.2 自定义IoT指标](#a2-自定义iot指标)
