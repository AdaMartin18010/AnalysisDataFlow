...
> 所属阶段: Knowledge/05-migrations | 前置依赖: [Flink DataStream API](../../Flink/09-language-foundations/flink-datastream-api-complete-guide.md), [Kafka Streams 官方文档](https://kafka.apache.org/documentation/streams/) | 形式化等级: L4
