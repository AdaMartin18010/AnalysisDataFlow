...
> 所属阶段: Knowledge/05-migrations | 前置依赖: [Flink DataStream API](../Flink/03-api-layer/ds-core-abstraction.md), [Kafka Streams 官方文档](https://kafka.apache.org/documentation/streams/) | 形式化等级: L4
