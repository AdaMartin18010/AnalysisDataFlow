# 流处理反模式专题 (Streaming Anti-patterns) {#流处理反模式专题-streaming-anti-patterns}
...
- [流处理反模式专题 (Streaming Anti-patterns) {#流处理反模式专题-streaming-anti-patterns}](#流处理反模式专题-streaming-anti-patterns-流处理反模式专题-streaming-anti-patterns)
  - [目录 {#目录}](#目录-目录)
  - [反模式速查表 {#反模式速查表}](#反模式速查表-反模式速查表)
  - [AP-01: 过度依赖处理时间而非事件时间 {#ap-01-过度依赖处理时间而非事件时间}](#ap-01-过度依赖处理时间而非事件时间-ap-01-过度依赖处理时间而非事件时间)
    - [问题描述 {#问题描述}](#问题描述-问题描述)
    - [错误示例 {#错误示例}](#错误示例-错误示例)
    - [负面影响 {#负面影响}](#负面影响-负面影响)
    - [解决方案 {#解决方案}](#解决方案-解决方案)
    - [关联设计模式 {#关联设计模式}](#关联设计模式-关联设计模式)
  - [AP-02: 忽略背压信号 {#ap-02-忽略背压信号}](#ap-02-忽略背压信号-ap-02-忽略背压信号)
    - [问题描述 {#问题描述-1}](#问题描述-问题描述-1)
    - [错误示例 {#错误示例-1}](#错误示例-错误示例-1)
    - [负面影响 {#负面影响-1}](#负面影响-负面影响-1)
    - [解决方案 {#解决方案-1}](#解决方案-解决方案-1)
    - [关联设计模式 {#关联设计模式-1}](#关联设计模式-关联设计模式-1)
  - [AP-03: 状态无限增长无TTL {#ap-03-状态无限增长无ttl}](#ap-03-状态无限增长无ttl-ap-03-状态无限增长无ttl)
    - [问题描述 {#问题描述-2}](#问题描述-问题描述-2)
    - [错误示例 {#错误示例-2}](#错误示例-错误示例-2)
    - [负面影响 {#负面影响-2}](#负面影响-负面影响-2)
    - [解决方案 {#解决方案-2}](#解决方案-解决方案-2)
    - [关联设计模式 {#关联设计模式-2}](#关联设计模式-关联设计模式-2)
  - [AP-04: 错误的Checkpoint配置 {#ap-04-错误的checkpoint配置}](#ap-04-错误的checkpoint配置-ap-04-错误的checkpoint配置)
    - [问题描述 {#问题描述-3}](#问题描述-问题描述-3)
    - [负面影响 {#负面影响-3}](#负面影响-负面影响-3)
    - [解决方案 {#解决方案-3}](#解决方案-解决方案-3)
    - [关联设计模式 {#关联设计模式-3}](#关联设计模式-关联设计模式-3)
  - [AP-05: 数据倾斜未处理 {#ap-05-数据倾斜未处理}](#ap-05-数据倾斜未处理-ap-05-数据倾斜未处理)
    - [问题描述 {#问题描述-4}](#问题描述-问题描述-4)
    - [错误示例 {#错误示例-3}](#错误示例-错误示例-3)
    - [负面影响 {#负面影响-4}](#负面影响-负面影响-4)
    - [解决方案 {#解决方案-4}](#解决方案-解决方案-4)
    - [关联设计模式 {#关联设计模式-4}](#关联设计模式-关联设计模式-4)
  - [AP-06: 滥用全局窗口 {#ap-06-滥用全局窗口}](#ap-06-滥用全局窗口-ap-06-滥用全局窗口)
    - [问题描述 {#问题描述-5}](#问题描述-问题描述-5)
    - [负面影响 {#负面影响-5}](#负面影响-负面影响-5)
    - [解决方案 {#解决方案-5}](#解决方案-解决方案-5)
    - [关联设计模式 {#关联设计模式-5}](#关联设计模式-关联设计模式-5)
  - [AP-07: 忽略迟到数据 {#ap-07-忽略迟到数据}](#ap-07-忽略迟到数据-ap-07-忽略迟到数据)
    - [问题描述 {#问题描述-6}](#问题描述-问题描述-6)
    - [错误示例 {#错误示例-4}](#错误示例-错误示例-4)
    - [负面影响 {#负面影响-6}](#负面影响-负面影响-6)
    - [解决方案 {#解决方案-6}](#解决方案-解决方案-6)
    - [关联设计模式 {#关联设计模式-6}](#关联设计模式-关联设计模式-6)
  - [AP-08: 不恰当的并行度设置 {#ap-08-不恰当的并行度设置}](#ap-08-不恰当的并行度设置-ap-08-不恰当的并行度设置)
    - [问题描述 {#问题描述-7}](#问题描述-问题描述-7)
    - [负面影响 {#负面影响-7}](#负面影响-负面影响-7)
    - [解决方案 {#解决方案-7}](#解决方案-解决方案-7)
    - [关联设计模式 {#关联设计模式-7}](#关联设计模式-关联设计模式-7)
  - [AP-09: 缺乏幂等性考虑 {#ap-09-缺乏幂等性考虑}](#ap-09-缺乏幂等性考虑-ap-09-缺乏幂等性考虑)
    - [问题描述 {#问题描述-8}](#问题描述-问题描述-8)
    - [错误示例 {#错误示例-5}](#错误示例-错误示例-5)
    - [负面影响 {#负面影响-8}](#负面影响-负面影响-8)
    - [解决方案 {#解决方案-8}](#解决方案-解决方案-8)
    - [关联设计模式 {#关联设计模式-8}](#关联设计模式-关联设计模式-8)
  - [AP-10: 监控和可观测性不足 {#ap-10-监控和可观测性不足}](#ap-10-监控和可观测性不足-ap-10-监控和可观测性不足)
    - [问题描述 {#问题描述-9}](#问题描述-问题描述-9)
    - [负面影响 {#负面影响-9}](#负面影响-负面影响-9)
    - [解决方案 {#解决方案-9}](#解决方案-解决方案-9)
    - [关联设计模式 {#关联设计模式-9}](#关联设计模式-关联设计模式-9)
  - [关联设计模式索引 {#关联设计模式索引}](#关联设计模式索引-关联设计模式索引)
  - [引用参考 (References) {#引用参考-references}](#引用参考-references-引用参考-references)
...
## AP-01: 过度依赖处理时间而非事件时间 {#ap-01-过度依赖处理时间而非事件时间}
...
```yaml
# Flink Kubernetes Operator 自动伸缩配置 {#flink-kubernetes-operator-自动伸缩配置}
spec:
  autoScaler:
    enabled: true
...
## AP-03: 状态无限增长无TTL {#ap-03-状态无限增长无ttl}
...
## AP-04: 错误的Checkpoint配置 {#ap-04-错误的checkpoint配置}
...
## AP-08: 不恰当的并行度设置 {#ap-08-不恰当的并行度设置}
...
## AP-10: 监控和可观测性不足 {#ap-10-监控和可观测性不足}
