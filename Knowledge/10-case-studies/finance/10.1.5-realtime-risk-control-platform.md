...
```yaml
# risk-engine-config.yaml version: "3.0"
...
```properties
# 使用静态成员避免不必要的重平衡 group.instance.id=flink-task-${taskId}
session.timeout.ms=45000
heartbeat.interval.ms=15000

# 增量重平衡 partition.assignment.strategy=org.apache.kafka.clients.consumer.CooperativeStickyAssignor
```
