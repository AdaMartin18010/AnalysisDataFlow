...
- [业务模式: 实时推荐系统 (business-pattern: real-time-recommendation)](#业务模式-实时推荐系统-business-pattern-real-time-recommendation)
  - [目录](#目录)
  - [1. 概念定义 (definitions)](#1-概念定义-definitions)
    - [def-k-03-04: 用户行为事件 (user-behavior-event)](#def-k-03-04-用户行为事件-user-behavior-event)
    - [def-k-03-05: 实时用户画像 (real-time-user-profile)](#def-k-03-05-实时用户画像-real-time-user-profile)
    - [def-k-03-06: 推荐候选集 (recommendation-candidates)](#def-k-03-06-推荐候选集-recommendation-candidates)
  - [2. 属性推导 (properties)](#2-属性推导-properties)
    - [prop-k-03-04: 特征新鲜度边界](#prop-k-03-04-特征新鲜度边界)
    - [prop-k-03-05: 异步 i/o 并发度上界](#prop-k-03-05-异步-io-并发度上界)
    - [prop-k-03-06: 推荐结果一致性](#prop-k-03-06-推荐结果一致性)
  - [3. 关系建立 (relations)](#3-关系建立-relations)
    - [3.1 与核心设计模式的关系](#31-与核心设计模式的关系)
    - [3.2 技术栈组件映射](#32-技术栈组件映射)
    - [3.3 特征计算时序关系](#33-特征计算时序关系)
  - [4. 论证过程 (argumentation)](#4-论证过程-argumentation)
    - [4.1 业务场景特点分析](#41-业务场景特点分析)
    - [4.2 实时 vs 离线特征权衡](#42-实时-vs-离线特征权衡)
    - [4.3 异步 i/o 超时处理策略](#43-异步-io-超时处理策略)
  - [5. 工程论证 (engineering-argument)](#5-工程论证-engineering-argument)
    - [5.1 架构设计决策](#51-架构设计决策)
    - [5.2 性能基准](#52-性能基准)
  - [6. 实例验证 (examples)](#6-实例验证-examples)
    - [6.1 用户行为实时特征计算](#61-用户行为实时特征计算)
    - [6.2 异步查询用户画像](#62-异步查询用户画像)
    - [6.3 top-k 推荐生成](#63-top-k-推荐生成)
    - [6.4 特征缺失处理](#64-特征缺失处理)
  - [7. 可视化 (visualizations)](#7-可视化-visualizations)
    - [7.1 推荐架构图](#71-推荐架构图)
    - [7.2 特征计算流程](#72-特征计算流程)
    - [7.3 模型推理集成](#73-模型推理集成)
