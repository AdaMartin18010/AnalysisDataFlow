...
> **所属阶段**: Knowledge/04-technology-selection | **前置依赖**: [../02-design-patterns/pattern-stateful-computation.md](../02-design-patterns/pattern-stateful-computation.md), [../../Flink/02-core-mechanisms/checkpoint-mechanism-deep-dive.md](../../Flink/02-core-mechanisms/checkpoint-mechanism-deep-dive.md) | **形式化等级**: L4

---

## 目录

- [存储系统选型指南 (Storage System Selection Guide)](#存储系统选型指南-storage-system-selection-guide)
  - [目录](#目录)
  ...
  - [3. 关系建立 (Relations)](#3-关系建立-relations)
    ...
    - [关系 2: 流处理引擎与状态后端绑定](#关系-2-流处理引擎与状态后端绑定)
    - [关系 3: 存储分层与数据流动](#关系-3-存储分层与数据流动)
  - [4. 论证过程 (Argumentation)](#4-论证过程-argumentation)
    - [论证 1: 状态大小与后端选择](#论证-1-状态大小与后端选择)
    - [论证 2: 一致性要求与存储选择](#论证-2-一致性要求与存储选择)
    - [论证 3: 成本敏感场景的存储优化](#论证-3-成本敏感场景的存储优化)
  - [5. 工程论证 (Engineering Argument)](#5-工程论证-engineering-argument)
    - [存储选型多维评估框架](#存储选型多维评估框架)
  - [6. 实例验证 (Examples)](#6-实例验证-examples)
    - [示例 1: 实时风控系统存储选型](#示例-1-实时风控系统存储选型)
    - [示例 2: IoT 数据处理存储选型](#示例-2-iot-数据处理存储选型)
    - [示例 3: 实时推荐系统存储选型](#示例-3-实时推荐系统存储选型)
    - [示例 4: 实时数仓存储选型](#示例-4-实时数仓存储选型)
    - [示例 5: 错误存储选型案例分析](#示例-5-错误存储选型案例分析)
  - [7. 可视化 (Visualizations)](#7-可视化-visualizations)
    - [图 7.1: 存储选型决策矩阵](#图-71-存储选型决策矩阵)
    - [图 7.2: 存储场景映射图](#图-72-存储场景映射图)
    - [图 7.3: 存储分层架构图](#图-73-存储分层架构图)
    - [图 7.4: 存储系统选型决策树](#图-74-存储系统选型决策树)
    - [图 7.5: 存储核心能力对比表](#图-75-存储核心能力对比表)
