...
- [流处理引擎选型指南 (Stream Processing Engine Selection Guide)](#流处理引擎选型指南-stream-processing-engine-selection-guide)
  - [目录](#目录)
  - [1. 概念定义 (Definitions)](#1-概念定义-definitions)
    - [Def-K-04-01. 流处理引擎 (Stream Processing Engine)](#def-k-04-01-流处理引擎-stream-processing-engine)
    - [Def-K-04-02. 延迟-吞吐权衡 (Latency-Throughput Trade-off)](#def-k-04-02-延迟-吞吐权衡-latency-throughput-trade-off)
    - [Def-K-04-03. 一致性级别 (Consistency Levels)](#def-k-04-03-一致性级别-consistency-levels)
    - [Def-K-04-04. 状态管理复杂度 (State Management Complexity)](#def-k-04-04-状态管理复杂度-state-management-complexity)
  - [2. 属性推导 (Properties)](#2-属性推导-properties)
    - [Lemma-K-04-01. 微批模型延迟下界](#lemma-k-04-01-微批模型延迟下界)
    - [Lemma-K-04-02. 原生流引擎吞吐上界](#lemma-k-04-02-原生流引擎吞吐上界)
    - [Prop-K-04-01. Exactly-Once 实现必要条件](#prop-k-04-01-exactly-once-实现必要条件)
  - [3. 关系建立 (Relations)](#3-关系建立-relations)
    - [关系 1: 引擎与表达能力层次映射](#关系-1-引擎与表达能力层次映射)
    - [关系 2: 引擎选择与设计模式依赖](#关系-2-引擎选择与设计模式依赖)
    - [关系 3: SQL支持与优化能力正相关](#关系-3-sql支持与优化能力正相关)
  - [4. 论证过程 (Argumentation)](#4-论证过程-argumentation)
    - [论证 1: 延迟要求的刚性约束](#论证-1-延迟要求的刚性约束)
    - [论证 2: 状态复杂度与引擎匹配](#论证-2-状态复杂度与引擎匹配)
    - [论证 3: Exactly-Once 的工程代价](#论证-3-exactly-once-的工程代价)
  - [5. 工程论证 (Engineering Argument)](#5-工程论证-engineering-argument)
    - [引擎选型多维评估框架](#引擎选型多维评估框架)
  - [6. 实例验证 (Examples)](#6-实例验证-examples)
    - [示例 1: 金融实时风控系统选型](#示例-1-金融实时风控系统选型)
    - [示例 2: IoT设备数据处理选型](#示例-2-iot设备数据处理选型)
    - [示例 3: 实时数仓 ETL 选型](#示例-3-实时数仓-etl-选型)
    - [示例 4: 错误选型案例分析](#示例-4-错误选型案例分析)
  - [7. 可视化 (Visualizations)](#7-可视化-visualizations)
    - [图 7.1: 流处理引擎对比矩阵](#图-71-流处理引擎对比矩阵)
    - [图 7.2: 引擎选型决策树](#图-72-引擎选型决策树)
    - [图 7.3: 引擎核心能力雷达图 (文本描述)](#图-73-引擎核心能力雷达图-文本描述)
