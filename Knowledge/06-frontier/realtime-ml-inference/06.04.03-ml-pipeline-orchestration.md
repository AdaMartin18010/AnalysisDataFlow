...
# 连接到 MLflow Tracking Server
mlflow.set_tracking_uri("http://mlflow-server:5000")
client = MlflowClient()

# 获取指定模型在 "Production" 阶段的最新版本
model_name = "click_through_rate_v1"
...
---
# Layer 1: Feature Engineering Job
apiVersion: flink.apache.org/v1beta1
