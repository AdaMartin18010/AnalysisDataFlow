...
> 所属阶段: Knowledge/06-frontier/realtime-ml-inference | 前置依赖: [Knowledge/06-frontier/realtime-ai-inference-architecture.md](../realtime-ai-inference-architecture.md), [Flink/06-ai-ml/flink-ml-inference-patterns.md](../../Flink/06-ai-ml/flink-ml-inference-patterns.md) | 形式化等级: L3
