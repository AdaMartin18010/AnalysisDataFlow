...
- [流数据访问控制模型 - RBAC/ABAC/ReBAC](#流数据访问控制模型---rbacabacrebac)
  ...
  - [3. 关系建立 (Relations)](#3-关系建立-relations)
    ...
    - [3.2 四大模型对比矩阵](#32-四大模型对比矩阵)
    - [3.3 与流处理概念的映射](#33-与流处理概念的映射)
    - [3.4 与Flink安全机制的整合](#34-与flink安全机制的整合)
  - [4. 论证过程 (Argumentation)](#4-论证过程-argumentation)
    - [4.1 流场景的特殊安全挑战](#41-流场景的特殊安全挑战)
      - [挑战1：低延迟 vs 细粒度访问控制的权衡](#挑战1低延迟-vs-细粒度访问控制的权衡)
      - [挑战2：数据血缘的追踪成本](#挑战2数据血缘的追踪成本)
      - [挑战3：动态数据脱敏的性能影响](#挑战3动态数据脱敏的性能影响)
    - [4.2 模型选择的决策框架](#42-模型选择的决策框架)
    - [4.3 合规性要求映射](#43-合规性要求映射)
  - [5. 工程论证 (Engineering Argument)](#5-工程论证-engineering-argument)
    - [5.1 Apache Ranger 集成方案](#51-apache-ranger-集成方案)
    - [5.2 自定义 Policy Engine 设计](#52-自定义-policy-engine-设计)
    - [5.3 与 Kafka ACL 的协同](#53-与-kafka-acl-的协同)
    - [5.4 性能优化策略](#54-性能优化策略)
  - [6. 实例验证 (Examples)](#6-实例验证-examples)
    - [6.1 金融实时风控场景](#61-金融实时风控场景)
    - [6.2 多租户 SaaS 平台](#62-多租户-saas-平台)
    - [6.3 数据血缘追踪实现](#63-数据血缘追踪实现)
    - [6.4 动态脱敏 Pipeline](#64-动态脱敏-pipeline)
  - [7. 可视化 (Visualizations)](#7-可视化-visualizations)
    - [7.1 访问控制模型对比雷达图](#71-访问控制模型对比雷达图)
    - [7.2 流数据访问控制架构图](#72-流数据访问控制架构图)
    - [7.3 策略传播决策树](#73-策略传播决策树)
    - [7.4 数据血缘与策略传播示例](#74-数据血缘与策略传播示例)
