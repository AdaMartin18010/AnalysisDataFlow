...
> 所属阶段: Knowledge/06-frontier | 前置依赖: [Flink 架构概述](../../Flink/02-architecture/flink-architecture-overview.md), [流处理模式](../02-design-patterns/stream-processing-patterns.md) | 形式化等级: L3
