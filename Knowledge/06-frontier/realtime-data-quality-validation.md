...
> **所属阶段**: Knowledge | **前置依赖**: [05-streaming-design-patterns.md](./05-streaming-design-patterns.md), [Flink/04-state-checkpoint/exactly-once-semantics.md](../../Flink/04-state-checkpoint/exactly-once-semantics.md) | **形式化等级**: L3
