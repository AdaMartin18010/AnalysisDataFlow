...
> **所属阶段**: Knowledge/06-frontier | **前置依赖**: [../04-technology-selection/flink-vs-risingwave.md](../04-technology-selection/flink-vs-risingwave.md), [risingwave-deep-dive.md](./risingwave-deep-dive.md), [../../Struct/03-stateful/stateful-computing-foundations.md](../../Struct/03-stateful/stateful-computing-foundations.md) | **形式化等级**: L4-L5
...
[^3]: F. McSherry et al., "Timely Dataflow: A General Purpose and Low Latency Dataflow System", SOSP 2013.

[^4]: Materialize Blog, "Consistency model: strict serializability", 2024. https://materialize.com/blog/consistency-model/

[^5]: M. Kleppmann, "Designing Data-Intensive Applications", O'Reilly, 2017.

[^6]: Apache Flink Documentation, "Stateful Stream Processing", 2025. https://nightlies.apache.org/flink/flink-docs-stable/

[^7]: RisingWave Documentation, "Architecture Overview", 2025. https://docs.risingwave.com/

[^8]: T. Akidau et al., "The Dataflow Model", PVLDB, 8(12), 2015.

[^9]: Materialize, "SQL Syntax Reference", 2025. https://materialize.com/docs/sql/

[^10]: Debezium Documentation, "Change Data Capture", 2025. https://debezium.io/

[^11]: F. McSherry, "Differential Privacy for Differential Dataflow", Blog, 2020.

[^12]: Materialize, "CDC Sources", 2025. https://materialize.com/docs/sql/create-source/
...
- [../../Struct/03-stateful/stateful-computing-foundations.md](../../Struct/03-stateful/stateful-computing-foundations.md) —— 有状态计算基础
