...
> 所属阶段: Knowledge | 前置依赖: [05-frontier/flink-cdc-patterns.md](../05-frontier/flink-cdc-patterns.md), [Flink/03-storage/flink-paimon-lakehouse.md](../../Flink/03-storage/flink-paimon-lakehouse.md) | 形式化等级: L3-L4
...
[^1]: Apache Iceberg Documentation, "Streaming Writes", 2025. https://iceberg.apache.org/docs/latest/flink/

[^2]: Apache Flink Documentation, "Iceberg Connector", 2025. https://nightlies.apache.org/flink/flink-docs-stable/docs/connectors/table/iceberg/

[^3]: Confluent Blog, "Introducing Tableflow: Streaming and Analytics Together", 2025. https://www.confluent.io/blog/introducing-tableflow/

[^4]: Redpanda Blog, "Iceberg Topics: Stream Processing Meets the Lakehouse", 2024. https://redpanda.com/blog/iceberg-topics-stream-processing-lakehouse

[^5]: Apache Paimon Documentation, "Architecture Overview", 2025. https://paimon.apache.org/docs/master/concepts/overview/

[^6]: RisingWave Documentation, "Sink to Iceberg", 2025. https://docs.risingwave.com/integrations/destinations/apache-iceberg

[^7]: Delta Lake Documentation, "Change Data Feed", 2025. https://docs.delta.io/latest/delta-change-data-feed.html

[^8]: 2026 Data Streaming Landscape, "Streaming-first Lakehouse Report", Confluent, 2026.

[^9]: Ryan Blue, "The Iceberg Specification: Design for Evolution", SIGMOD 2024.

[^10]: Jingsong Lee, "Apache Paimon: A Streaming Lakehouse", VLDB 2024.

[^11]: Databricks, "Delta Lake 3.0: Predictive I/O and Liquid Clustering", 2024.

[^12]: Netflix Tech Blog, "Streaming SQL with Iceberg at Netflix", 2025.
