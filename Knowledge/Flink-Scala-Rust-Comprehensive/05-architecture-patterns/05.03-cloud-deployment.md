...
> **所属阶段**: Knowledge/Flink-Scala-Rust-Comprehensive | **前置依赖**: [02.05-flink-cloud-native.md](Knowledge/Flink-Scala-Rust-Comprehensive/02-flink-system/02.05-flink-cloud-native.md), [05.01-hybrid-architecture-patterns.md](./05.01-hybrid-architecture-patterns.md) | **形式化等级**: L4-L5 (生产实践)
