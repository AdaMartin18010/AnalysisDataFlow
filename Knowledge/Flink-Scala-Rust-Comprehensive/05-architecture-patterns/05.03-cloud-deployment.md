...
```yaml
# flink-production.yaml apiVersion: flink.apache.org/v1beta1
...
```yaml
# hpa-custom-metrics.yaml apiVersion: autoscaling/v2
...
```yaml
# prometheus-servicemonitor.yaml apiVersion: monitoring.coreos.com/v1
kind: ServiceMonitor
metadata:
  name: flink-metrics
  namespace: monitoring
