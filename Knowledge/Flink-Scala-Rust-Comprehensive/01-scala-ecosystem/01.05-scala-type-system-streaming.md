...
> 所属阶段: Knowledge/Flink-Scala-Rust-Comprehensive | 前置依赖: [01.04-fs2-pekko-streams.md](./01.04-fs2-pekko-streams.md), [Flink/03-api/09-language-foundations/01.03-scala3-type-system-formalization.md](../../../Flink/03-api/09-language-foundations/01.02-typeinformation-derivation.md) | 形式化等级: L5-L6
