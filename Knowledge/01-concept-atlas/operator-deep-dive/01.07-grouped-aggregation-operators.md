...
> 所属阶段: Knowledge/01-concept-atlas/operator-deep-dive | 前置依赖: [01.06-single-input-operators.md](./01.06-single-input-operators.md), [02.01-state-model.md](../../../Struct/02-properties/02.01-state-model.md) | 形式化等级: L4
