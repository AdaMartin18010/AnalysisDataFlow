...
> **所属阶段**: Knowledge | **前置依赖**: [07.01-flink-production-checklist.md](./07.01-flink-production-checklist.md), [Flink/03-api-comparison/03.01-datastream-api-guide.md](../../Flink/03-sql-table-api/sql-vs-datastream-comparison.md) | **形式化等级**: L4
...
public class StatefulCounterTest {
    ...
    public void setup() throws Exception {
        ...
        // 配置状态后端
        harness.setup(new MemoryStateBackend());
        harness.open();
    }
