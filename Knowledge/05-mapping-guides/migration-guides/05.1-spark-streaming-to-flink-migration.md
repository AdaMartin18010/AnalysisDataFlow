...
> 所属阶段: Knowledge/05-mapping-guides/migration-guides | 前置依赖: [Flink DataStream API](../../../Flink/09-language-foundations/flink-datastream-api-complete-guide.md), [Spark Streaming 架构](https://spark.apache.org/docs/latest/streaming-programming-guide.html) | 形式化等级: L4
