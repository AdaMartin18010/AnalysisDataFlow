...
> 所属阶段: Knowledge/05-mapping-guides/migration-guides | 前置依赖: [Flink Kafka Connector](../../../Flink/04-connectors/flink-connectors-ecosystem-complete-guide.md), [Kafka Streams DSL](https://kafka.apache.org/documentation/streams/) | 形式化等级: L4
