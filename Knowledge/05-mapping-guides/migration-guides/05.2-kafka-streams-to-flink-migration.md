...
> 所属阶段: Knowledge/05-mapping-guides/migration-guides | 前置依赖: [Flink Kafka Connector](../../Flink/03-api-layer/connectors/kafka-connector.md), [Kafka Streams DSL](https://kafka.apache.org/documentation/streams/) | 形式化等级: L4
