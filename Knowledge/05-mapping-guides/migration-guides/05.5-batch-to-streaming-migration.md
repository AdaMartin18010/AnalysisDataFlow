...
> 所属阶段: Knowledge/05-mapping-guides/migration-guides | 前置依赖: [Flink DataStream API](../../Flink/03-api-layer/ds-core-abstraction.md), [Time Semantics](../../Flink/02-core-mechanisms/time-semantics.md) | 形式化等级: L3
