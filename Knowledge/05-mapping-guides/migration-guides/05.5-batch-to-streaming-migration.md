...
> 所属阶段: Knowledge/05-mapping-guides/migration-guides | 前置依赖: [Flink DataStream API](../../../Flink/09-language-foundations/flink-datastream-api-complete-guide.md), [Time Semantics](../../../Flink/02-core-mechanisms/time-semantics-and-watermark.md) | 形式化等级: L3
