...
> 所属阶段: Knowledge/05-mapping-guides/migration-gives | 前置依赖: [Flink JobGraph](../../../Flink/01-architecture/deployment-architectures.md), [Storm Topology](https://storm.apache.org/releases/current/Concepts.html) | 形式化等级: L4
