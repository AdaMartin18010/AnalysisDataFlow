...
- [AnalysisDataFlow 综合索引可视化](#analysisdataflow-综合索引可视化)
  - [目录](#目录)
  - [1. 索引总览](#1-索引总览)
    - [1.1 项目统计](#11-项目统计)
    - [1.2 三层知识架构](#12-三层知识架构)
  - [2. 多维索引系统](#2-多维索引系统)
    - [2.1 按主题索引](#21-按主题索引)
      - [理论基础 (Struct/)](#理论基础-struct)
      - [工程实践 (Knowledge/)](#工程实践-knowledge)
      - [前沿技术](#前沿技术)
    - [2.2 按问题索引](#22-按问题索引)
      - [Checkpoint相关问题](#checkpoint相关问题)
      - [背压与流控问题](#背压与流控问题)
      - [数据倾斜问题](#数据倾斜问题)
      - [延迟优化问题](#延迟优化问题)
      - [Exactly-Once问题](#exactly-once问题)
    ...
    - [2.4 按业务领域索引](#24-按业务领域索引)
      ...
      - [日志监控](#日志监控)
  - [3. 索引网络图](#3-索引网络图)
    - [3.1 主题关联网络](#31-主题关联网络)
    - [3.2 问题-解决方案映射网络](#32-问题-解决方案映射网络)
    - [3.3 业务领域-技术栈映射网络](#33-业务领域-技术栈映射网络)
  - [4. 快速查找决策树](#4-快速查找决策树)
    - [4.1 主题查找决策树](#41-主题查找决策树)
    - [4.2 技术选型决策树](#42-技术选型决策树)
    - [4.3 业务场景决策树](#43-业务场景决策树)
  - [5. 全文搜索指南](#5-全文搜索指南)
    - [5.1 搜索工具使用](#51-搜索工具使用)
    - [5.2 搜索策略建议](#52-搜索策略建议)
    - [5.3 编号体系速查](#53-编号体系速查)
  - [6. 角色化导航](#6-角色化导航)
    - [6.1 架构师导航](#61-架构师导航)
    - [6.2 开发工程师导航](#62-开发工程师导航)
    - [6.3 研究员导航](#63-研究员导航)
    - [6.4 学生导航](#64-学生导航)
  - [7. 核心索引入口](#7-核心索引入口)
    - [7.1 主索引文件](#71-主索引文件)
    - [7.2 快速决策参考](#72-快速决策参考)
    - [7.3 故障排查速查](#73-故障排查速查)
  - [附录: 索引网络图全景](#附录-索引网络图全景)
  - [引用参考](#引用参考)
