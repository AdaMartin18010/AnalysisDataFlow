...
- [Proofs 层剩余定理推导链文档](#proofs-层剩余定理推导链文档)
  ...
  - [2. Watermark 代数证明簇 (Thm-S-20-XX)](#2-watermark-代数证明簇-thm-s-20-xx)
    - [2.1 完全格定理 Thm-S-20-19](#21-完全格定理-thm-s-20-19)
    - [2.2 合并算子性质 Thm-S-20-35 ~ Thm-S-20-42](#22-合并算子性质-thm-s-20-35-thm-s-20-42)
      - [Thm-S-20-36: 结合律 (Associativity)](#thm-s-20-36-结合律-associativity)
      - [Thm-S-20-45: 交换律 (Commutativity)](#thm-s-20-45-交换律-commutativity)
      - [Thm-S-20-48: 幂等律 (Idempotence)](#thm-s-20-48-幂等律-idempotence)
      - [Thm-S-20-43: 吸收律 (Absorption)](#thm-s-20-43-吸收律-absorption)
    - [2.3 传播单调性 Thm-S-20-51 ~ Thm-S-20-54](#23-传播单调性-thm-s-20-51-thm-s-20-54)
      - [Thm-S-20-06: 算子传播单调性](#thm-s-20-06-算子传播单调性)
      - [Thm-S-20-07: 全局单调性](#thm-s-20-07-全局单调性)
      - [Thm-S-20-08: 边界保持性](#thm-s-20-08-边界保持性)
    - [2.4 多源流协调 Thm-S-20-58 ~ Thm-S-20-61](#24-多源流协调-thm-s-20-58-thm-s-20-61)
      - [Thm-S-20-09: 多源流合并完备性](#thm-s-20-09-多源流合并完备性)
      - [Thm-S-20-62: Watermark 延迟边界](#thm-s-20-62-watermark-延迟边界)
  - [3. 类型安全证明簇 (Thm-S-21-XX)](#3-类型安全证明簇-thm-s-21-xx)
    - [3.1 FG 类型安全 Thm-S-21-12](#31-fg-类型安全-thm-s-21-12)
    - [3.2 FGG 泛型保持 Thm-S-21-23](#32-fgg-泛型保持-thm-s-21-23)
    - [3.3 方法解析完备性 Thm-S-21-27 ~ Thm-S-21-30](#33-方法解析完备性-thm-s-21-27-thm-s-21-30)
      - [Thm-S-21-03: 方法集闭包性](#thm-s-21-03-方法集闭包性)
      - [Thm-S-21-04: 动态分派正确性](#thm-s-21-04-动态分派正确性)
      - [Thm-S-21-05: 接口实现完备性](#thm-s-21-05-接口实现完备性)
    - [3.4 类型替换引理组 Thm-S-21-34 ~ Thm-S-21-37](#34-类型替换引理组-thm-s-21-34-thm-s-21-37)
      - [Thm-S-21-06: 替换与类型保持](#thm-s-21-06-替换与类型保持)
      - [Thm-S-21-41 ~ Thm-S-21-38: 辅助引理组](#thm-s-21-41-thm-s-21-38-辅助引理组)
  - [4. 子类型完备性证明簇 (Thm-S-22-XX)](#4-子类型完备性证明簇-thm-s-22-xx)
    - [4.1 DOT 子类型判定 Thm-S-22-12](#41-dot-子类型判定-thm-s-22-12)
    - [4.2 路径类型良构性 Thm-S-22-25 ~ Thm-S-22-30](#42-路径类型良构性-thm-s-22-25-thm-s-22-30)
      - [Thm-S-22-26: 路径良构性](#thm-s-22-26-路径良构性)
      - [Thm-S-22-33: 路径等价判定](#thm-s-22-33-路径等价判定)
      - [Thm-S-22-31: 路径类型一致性](#thm-s-22-31-路径类型一致性)
    - [4.3 名义vs结构子类型 Thm-S-22-36 ~ Thm-S-22-39](#43-名义vs结构子类型-thm-s-22-36-thm-s-22-39)
      - [Thm-S-22-05: 名义子类型判定](#thm-s-22-05-名义子类型判定)
      - [Thm-S-22-06: 结构子类型完备性](#thm-s-22-06-结构子类型完备性)
      - [Thm-S-22-07: 混合系统一致性](#thm-s-22-07-混合系统一致性)
    - [4.4 递归类型展开 Thm-S-22-43 ~ Thm-S-22-46](#44-递归类型展开-thm-s-22-43-thm-s-22-46)
      - [Thm-S-22-08: mu 类型展开等价性](#thm-s-22-08-mu-类型展开等价性)
      - [Thm-S-22-09: 递归类型终止性](#thm-s-22-09-递归类型终止性)
      - [Thm-S-22-47: F-有界多态保持](#thm-s-22-47-f-有界多态保持)
  - [5. 死锁自由证明簇 (Thm-S-23-XX)](#5-死锁自由证明簇-thm-s-23-xx)
    - [5.1 Choreographic 死锁自由 Thm-S-23-12](#51-choreographic-死锁自由-thm-s-23-12)
    - [5.2 EPP 投影保持 Thm-S-23-36 ~ Thm-S-23-41](#52-epp-投影保持-thm-s-23-36-thm-s-23-41)
      - [Thm-S-23-37: EPP 完备性](#thm-s-23-37-epp-完备性)
      - [Thm-S-23-44: 投影语义保持](#thm-s-23-44-投影语义保持)
      - [Thm-S-23-42: 合并重构性](#thm-s-23-42-合并重构性)
    - [5.3 全局类型合成 Thm-S-23-47 ~ Thm-S-23-50](#53-全局类型合成-thm-s-23-47-thm-s-23-50)
      - [Thm-S-23-05: 类型合成完备性](#thm-s-23-05-类型合成完备性)
      - [Thm-S-23-06: 合成唯一性](#thm-s-23-06-合成唯一性)
      - [Thm-S-23-07: 合成与投影互逆](#thm-s-23-07-合成与投影互逆)
    - [5.4 多角色协调 Thm-S-23-54 ~ Thm-S-23-57](#54-多角色协调-thm-s-23-54-thm-s-23-57)
      - [Thm-S-23-08: 广播通信安全](#thm-s-23-08-广播通信安全)
      - [Thm-S-23-09: 多路选择完备性](#thm-s-23-09-多路选择完备性)
      - [Thm-S-23-58: 动态角色创建](#thm-s-23-58-动态角色创建)
  - [6. 其他正确性证明 (Thm-S-24-XX)](#6-其他正确性证明-thm-s-24-xx)
    - [6.1 Go vs Scala 图灵等价 Thm-S-24-22](#61-go-vs-scala-图灵等价-thm-s-24-22)
    - [6.2 并发原语表达能力 Thm-S-24-29 ~ Thm-S-24-32](#62-并发原语表达能力-thm-s-24-29-thm-s-24-32)
      ...
      - [Thm-S-24-33: Context 传播正确性](#thm-s-24-33-context-传播正确性)
    - [6.3 内存模型精化 Thm-S-24-38 ~ Thm-S-24-41](#63-内存模型精化-thm-s-24-38-thm-s-24-41)
    ...
    - [6.4 编译正确性 Thm-S-24-47 ~ Thm-S-24-50](#64-编译正确性-thm-s-24-47-thm-s-24-50)
    ...
    - [6.5 优化保持性 Thm-S-24-56 ~ Thm-S-24-59](#65-优化保持性-thm-s-24-56-thm-s-24-59)
      ...
      - [Thm-S-24-60: 尾调用优化条件](#thm-s-24-60-尾调用优化条件)
  - [7. 证明技术对比表](#7-证明技术对比表)
  - [8. 机器验证状态](#8-机器验证状态)
