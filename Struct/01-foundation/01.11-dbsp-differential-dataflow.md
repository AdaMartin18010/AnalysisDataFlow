...
- [DBSP / Differential Dataflow 理论形式化 (Differential Stream Processing Theory)](#dbsp--differential-dataflow-理论形式化-differential-stream-processing-theory)
  - [目录](#目录)
  ...
  - [3. 关系建立 (Relations)](#3-关系建立-relations)
    - [关系 1: DBSP `↔` Dataflow Model (Flink 基础)](#关系-1-dbsp--dataflow-model-flink-基础)
    - [关系 2: DBSP `⊂` USTM 统一流理论](#关系-2-dbsp--ustm-统一流理论)
    - [关系 3: DBSP `↦` 关系代数 / SQL 语义](#关系-3-dbsp--关系代数--sql-语义)
