...
### 关系 1: Dataflow Model `⊃` Kahn 进程网络 (KPN) {#关系-1-dataflow-model--kahn-进程网络-kpn} {#关系-1-dataflow-model--kahn-进程网络-kpn-关系-1-dataflow-model--kahn-进程网络-kpn}
...
### 关系 2: 同步数据流 (SDF) `⊂` 动态数据流 (DDF) `≈` Dataflow Model {#关系-2-同步数据流-sdf--动态数据流-ddf--dataflow-model} {#关系-2-同步数据流-sdf--动态数据流-ddf--dataflow-model-关系-2-同步数据流-sdf--动态数据流-ddf--dataflow-model}
...
### 关系 3: Dataflow 理论模型 `↦` Flink Runtime 实现 {#关系-3-dataflow-理论模型--flink-runtime-实现} {#关系-3-dataflow-理论模型--flink-runtime-实现-关系-3-dataflow-理论模型--flink-runtime-实现}
