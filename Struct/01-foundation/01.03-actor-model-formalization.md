# Actor 模型形式化 (Actor Model Formalization) {#关系-1-classic-actor--erlang-actor}
...
### Def-S-03-01. Actor (经典 Actor 模型) {#关系-2-actor-模型--异步-π-演算}
...
### 论证 1：为什么邮箱串行处理是 Actor 确定性的根基 {#关系-4-actor-模型--dataflow-模型图灵完备等价}
