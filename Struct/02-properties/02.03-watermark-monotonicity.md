# Watermark 单调性定理 (Watermark Monotonicity Theorem) {#步骤-1基例--source-算子的-watermark-单调性-步骤-1-基例--source-算子的-watermark-单调性}
...
### 步骤 2：归纳假设 {#步骤-3归纳步骤--第-k-个算子的单调性保持-步骤-3-归纳步骤--第-k-个算子的单调性保持}
