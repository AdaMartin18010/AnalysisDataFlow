...
- [流计算一致性层级 (Consistency Hierarchy in Streaming)](#流计算一致性层级-consistency-hierarchy-in-streaming)
  ...
  - [3. 关系建立 (Relations)](#3-关系建立-relations)
    ...
    - [关系 2: 内部一致性 `≈` Chandy-Lamport 分布式快照 {#关系-2-内部一致性--chandy-lamport-分布式快照}](#关系-2-内部一致性--chandy-lamport-分布式快照-关系-2-内部一致性--chandy-lamport-分布式快照)
...
### 关系 1: Dataflow 确定性定理与一致性层级的联系 {#关系-2-内部一致性--chandy-lamport-分布式快照-关系-2-内部一致性--chandy-lamport-分布式快照}
