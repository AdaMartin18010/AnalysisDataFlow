# 活性与安全性形式化 (Liveness and Safety Properties)

> **理论定位**: L4-L5 形式化验证核心 | **关联**: [01.03-actor-model-formalization](../01-concepts/01.03-actor-model-formalization.md) | **复杂度**: PSPACE-完全 (LTL), 多项式时间 (CTL)

---

## 目录

- [活性与安全性形式化 (Liveness and Safety Properties)](#活性与安全性形式化-liveness-and-safety-properties)
  - [目录](#目录)
...
给定Actor系统 $\mathcal{A} = (\alpha, b, m, \sigma)$（参见 [01.03-actor-model-formalization](../01-concepts/01.03-actor-model-formalization.md)）：
...
2. 由 [01.03-actor-model-formalization](../01-concepts/01.03-actor-model-formalization.md)，Actor只能通过消息传递影响对方
...
1. 由Actor模型公理（[01.03-actor-model-formalization](../01-concepts/01.03-actor-model-formalization.md)），Actor具有：
...
- [01.03-actor-model-formalization](../01-concepts/01.03-actor-model-formalization.md) — Actor模型形式化定义
- [02.03-concurrent-composition](./02.03-concurrent-composition.md) — 并发组合理论
- [03.01-temporal-logics](../03-analysis/03.01-temporal-logics.md) — 时态逻辑分析
