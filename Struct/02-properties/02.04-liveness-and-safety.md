...
- [活性与安全性形式化 (Liveness and Safety Properties) {#活性与安全性形式化}](#活性与安全性形式化-liveness-and-safety-properties-活性与安全性形式化)
  ...
  - [3. 关系建立 (Relations)](#3-关系建立-relations)
    - [关系 1: 安全性 `⊂` 闭集 (Borel拓扑) {#关系-1-安全性--闭集-borel拓扑}](#关系-1-安全性--闭集-borel拓扑-关系-1-安全性--闭集-borel拓扑)
    - [关系 2: 活性 `≈` 稠密集 {#关系-2-活性--稠密集}](#关系-2-活性--稠密集-关系-2-活性--稠密集)
    - [关系 3: Actor模型 `⊆` 活性验证需公平性 {#关系-3-actor模型--活性验证需公平性}](#关系-3-actor模型--活性验证需公平性-关系-3-actor模型--活性验证需公平性)
  ...
  - [6. 实例与反例 (Examples \& Counter-examples) {#6-实例与反例-examples--counter-examples}](#6-实例与反例-examples--counter-examples-6-实例与反例-examples--counter-examples)
