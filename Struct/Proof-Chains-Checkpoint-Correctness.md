...
- [推导链: Checkpoint 正确性完整证明](#推导链-checkpoint-正确性完整证明)
  ...
  - [2. 基础定义层 (Layer 1)](#2-基础定义层-layer-1)
    - [2.1 Def-S-01-18: Dataflow Model](#21-def-s-01-04-dataflow-model)
    - [2.2 Def-S-04-11: Dataflow 图 (DAG)](#22-def-s-04-01-dataflow-图-dag)
    - [2.3 Def-S-04-84: 算子语义](#23-def-s-04-02-算子语义)
    - [2.4 Def-S-04-133: 事件时间与 Watermark](#24-def-s-04-04-事件时间与-watermark)
    - [2.5 Def-S-02-67: π-Calculus](#25-def-s-02-03-π-calculus)
  - [3. 性质推导层 (Layer 2)](#3-性质推导层-layer-2)
    - [3.1 Lemma-S-04-11: 算子局部确定性](#31-lemma-s-04-01-算子局部确定性)
    - [3.2 Lemma-S-04-51: Watermark 单调性保持](#32-lemma-s-04-02-watermark-单调性保持)
    - [3.3 Def-S-09-18: Watermark 进度语义](#33-def-s-09-02-watermark-进度语义)
    - [3.4 Lemma-S-02-06-01: Watermark 边界保证](#34-lemma-s-02-03-01-watermark-边界保证)
  - [4. 关系建立层 (Layer 3)](#4-关系建立层-layer-3)
    - [4.1 Thm-S-03-15: Flink→π-Calculus 保持定理](#41-thm-s-03-02-flinkπ-calculus-保持定理)
    - [4.2 Def-S-13-14: Flink 算子→π-Calculus 编码](#42-def-s-13-01-flink-算子π-calculus-编码)
    - [4.3 Def-S-13-30: Checkpoint→Barrier 同步编码](#43-def-s-13-03-checkpointbarrier-同步编码)
  - [5. 形式证明层 (Layer 4)](#5-形式证明层-layer-4)
    - [5.1 Def-S-17-08: Checkpoint Barrier 语义](#51-def-s-17-01-checkpoint-barrier-语义)
    - [5.2 Lemma-S-17-08: Barrier 传播不变式](#52-lemma-s-17-01-barrier-传播不变式)
    - [5.3 Lemma-S-17-34: 状态一致性引理](#53-lemma-s-17-02-状态一致性引理)
    - [5.4 Thm-S-17-15: Flink Checkpoint 一致性定理](#54-thm-s-17-01-flink-checkpoint-一致性定理)
  - [6. 工程实现映射](#6-工程实现映射)
