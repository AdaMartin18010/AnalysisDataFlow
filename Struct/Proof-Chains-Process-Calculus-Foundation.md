...
- [进程演算基础定理完整推导链](#进程演算基础定理完整推导链)
  ...
  - [1. 概念定义 (Definitions)](#1-概念定义-definitions)
    - [Def-S-02-36: CCS 语法与操作语义](#def-s-02-36-ccs-语法与操作语义)
    - [Def-S-02-57: CSP 语法与语义](#def-s-02-57-csp-语法与语义)
    - [Def-S-02-84: π-Calculus 语法与移动性](#def-s-02-84-π-calculus-语法与移动性)
    - [Def-S-02-98: 二进制会话类型](#def-s-02-98-二进制会话类型)
  - [2. 属性推导 (Properties)](#2-属性推导-properties)
    - [Lemma-S-02-17: 静态通道模型的拓扑不变性](#lemma-s-02-17-静态通道模型的拓扑不变性)
    - [Lemma-S-02-27: 动态通道演算的图灵完备性](#lemma-s-02-27-动态通道演算的图灵完备性)
    - [Lemma-S-15-06: 强互模拟是等价关系](#lemma-s-15-06-强互模拟是等价关系)
    - [Lemma-S-15-17: 互模拟蕴含迹等价反之不成立](#lemma-s-15-17-互模拟蕴含迹等价反之不成立)
    - [Lemma-S-15-29: 弱互模拟的复合保持性](#lemma-s-15-29-弱互模拟的复合保持性)
    - [Lemma-S-15-31: 互模拟关系的最大不动点刻画](#lemma-s-15-31-互模拟关系的最大不动点刻画)
  ...
  - [5. 形式证明 / 工程论证 (Proof / Engineering Argument)](#5-形式证明-工程论证-proof-engineering-argument)
    - [Thm-S-02-22: 动态通道演算严格包含静态通道演算](#thm-s-02-22-动态通道演算严格包含静态通道演算)
    - [Thm-S-02-34: 有限控制静态演算可判定性](#thm-s-02-34-有限控制静态演算可判定性)
    - [Thm-S-02-36: 进程组合保持互模拟](#thm-s-02-36-进程组合保持互模拟)
    - [Thm-S-15-17: 互模拟同余定理](#thm-s-15-17-互模拟同余定理)
