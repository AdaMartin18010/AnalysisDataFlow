...
- [Foundation 层（01-foundation）全量定义推导链](#foundation-层01-foundation全量定义推导链)
  ...
  - [2. USTM 核心定义簇 (Def-S-01-\*)](#2-ustm-核心定义簇-def-s-01)
    - [Def-S-01-133: USTM 统一流计算元模型](#def-s-01-133-ustm-统一流计算元模型)
    - [Def-S-01-70: 六层表达能力层次](#def-s-01-70-六层表达能力层次)
    - [Def-S-01-114: Processor 处理器](#def-s-01-114-processor-处理器)
    - [Def-S-01-23: Channel 通道](#def-s-01-23-channel-通道)
    - [Def-S-01-143: TimeModel 时间模型](#def-s-01-143-timemodel-时间模型)
    - [Def-S-01-147: Consistency Model 一致性模型](#def-s-01-147-consistency-model-一致性模型)
    - [Def-S-01-07: UCM 统一并发模型](#def-s-01-07-ucm-统一并发模型)
  - [3. 进程演算定义簇 (Def-S-02-\*)](#3-进程演算定义簇-def-s-02)
    - [Def-S-02-25: CCS (Calculus of Communicating Systems)](#def-s-02-25-ccs-calculus-of-communicating-systems)
    - [Def-S-02-51: CSP 核心语法](#def-s-02-51-csp-核心语法)
    - [Def-S-02-74: π-Calculus](#def-s-02-74-π-calculus)
    - [Def-S-02-94: 二进制会话类型 (Binary Session Types)](#def-s-02-94-二进制会话类型-binary-session-types)
  - [4. Actor 模型定义簇 (Def-S-03-\*)](#4-actor-模型定义簇-def-s-03)
    - [Def-S-03-22: Actor (经典 Actor 模型)](#def-s-03-22-actor-经典-actor-模型)
    - [Def-S-03-60: Behavior 行为](#def-s-03-60-behavior-行为)
    - [Def-S-03-74: Mailbox 邮箱](#def-s-03-74-mailbox-邮箱)
    - [Def-S-03-85: ActorRef 不透明引用](#def-s-03-85-actorref-不透明引用)
    - [Def-S-03-101: Supervision Tree 监督树](#def-s-03-101-supervision-tree-监督树)
  - [5. Dataflow 模型定义簇 (Def-S-04-\*)](#5-dataflow-模型定义簇-def-s-04)
    - [Def-S-04-40: Dataflow 图 (DAG)](#def-s-04-40-dataflow-图-dag)
    - [Def-S-04-105: 算子语义 (Operator)](#def-s-04-105-算子语义-operator)
    - [Def-S-04-196: 流作为偏序多重集](#def-s-04-196-流作为偏序多重集)
    - [Def-S-04-150: Watermark 水印](#def-s-04-150-watermark-水印)
    - [Def-S-04-205: 窗口形式化 (Window)](#def-s-04-205-窗口形式化-window)
  - [6. CSP 形式化定义簇 (Def-S-05-\*)](#6-csp-形式化定义簇-def-s-05)
    - [Def-S-05-24: CSP 核心语法](#def-s-05-24-csp-核心语法)
    - [Def-S-05-14: CSP 结构化操作语义 (SOS)](#def-s-05-14-csp-结构化操作语义-sos)
    - [Def-S-05-41: CSP 迹/失败/发散语义](#def-s-05-41-csp-迹失败发散语义)
    - [Def-S-05-48: CSP 通道与同步原语](#def-s-05-48-csp-通道与同步原语)
    - [Def-S-05-52: Go-CS-sync 到 CSP 编码](#def-s-05-52-go-cs-sync-到-csp-编码)
  - [7. Petri 网定义簇 (Def-S-06-\*)](#7-petri-网定义簇-def-s-06)
    - [Def-S-06-16: P/T 网 (Place/Transition Net)](#def-s-06-16-pt-网-placetransition-net)
    - [Def-S-06-29: 变迁触发规则 (Firing Rule)](#def-s-06-29-变迁触发规则-firing-rule)
    - [Def-S-06-36: 可达性与可达图](#def-s-06-36-可达性与可达图)
    - [Def-S-06-43: 着色 Petri 网 (CPN)](#def-s-06-43-着色-petri-网-cpn)
    - [Def-S-06-48: 时间 Petri 网 (TPN)](#def-s-06-48-时间-petri-网-tpn)
  - [8. 会话类型定义簇 (Def-S-07-\*)](#8-会话类型定义簇-def-s-07)
    - [Def-S-01-155: 二元会话类型语法](#def-s-01-155-二元会话类型语法)
    - [Def-S-01-161: 双寡规则 (Duality)](#def-s-01-161-双寡规则-duality)
    - [Def-S-01-164: 全局类型 (Global Types)](#def-s-01-164-全局类型-global-types)
