...
> **所属阶段**: Struct/04-proofs | **前置依赖**: [../02-properties/02.02-consistency-hierarchy.md](../02-properties/02.02-consistency-hierarchy.md) | **形式化等级**: L5 | **TLA+ 规范**: `AcotorCSPWorkflow/formal-proofs/flink-checkpoint/FlinkCheckpoint.tla`
...
*TLA+ 规范验证: `AcotorCSPWorkflow/formal-proofs/flink-checkpoint/FlinkCheckpoint.tla`*
