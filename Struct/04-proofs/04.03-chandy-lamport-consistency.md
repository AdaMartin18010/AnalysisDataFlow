...
- [Chandy-Lamport 快照一致性证明 (Chandy-Lamport Snapshot Consistency Proof)](#chandy-lamport-快照一致性证明-chandy-lamport-snapshot-consistency-proof)
  ...
  - [3. 关系建立 (Relations)](#3-关系建立-relations)
    - [关系 1: Marker 接收 `↦` 状态记录触发 {#关系-1-marker-接收--状态记录触发}](#关系-1-marker-接收--状态记录触发-关系-1-marker-接收--状态记录触发)
    - [关系 2: 通道记录规则 `⟹` 无消息丢失或重复 {#关系-2-通道记录规则--无消息丢失或重复}](#关系-2-通道记录规则--无消息丢失或重复-关系-2-通道记录规则--无消息丢失或重复)
    - [关系 3: Chandy-Lamport `≈` Flink Checkpoint (语义等价) {#关系-3-chandy-lamport--flink-checkpoint-语义等价}](#关系-3-chandy-lamport--flink-checkpoint-语义等价-关系-3-chandy-lamport--flink-checkpoint-语义等价)
  ...
  - [6. 实例验证 (Examples)](#6-实例验证-examples)
    ...
    - [示例 6.2: 环形拓扑中的 Marker 传播](#示例-62-环形拓扑中的-marker-传播)
...
### 示例 6.2: 环形拓扑中的 Marker 传播 {#关系-1-marker-接收--状态记录触发-关系-1-marker-接收--状态记录触发}
