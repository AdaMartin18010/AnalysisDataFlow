...
> **所属阶段**: Struct/04-proofs | **前置依赖**: [../04-proofs/04.01-flink-checkpoint-correctness.md](../04-proofs/04.01-flink-checkpoint-correctness.md) | **形式化等级**: L5 | **TLA+ 规范**: `AcotorCSPWorkflow/deep/03-distributed-systems/Distributed-Consensus-TLA.md`
...
### 关系 3: Chandy-Lamport `≈` Flink Checkpoint (语义等价)
