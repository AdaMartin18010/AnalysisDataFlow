# Watermark 代数形式证明 (Watermark Algebra Formal Proof) {#关系-1-watermark-格--完备格理论-关系-1-watermark-格--完备格理论}
...
- [Watermark 代数形式证明 (Watermark Algebra Formal Proof)](#watermark-代数形式证明-watermark-algebra-formal-proof)
  ...
  - [3. 关系建立 (Relations)](#3-关系建立-relations)
    ...
    - [关系 2: Watermark 合并 `⟹` 单调性保持 {#关系-2-watermark-合并--单调性保持}](#关系-2-watermark-合并--单调性保持-关系-2-watermark-合并--单调性保持)
    - [关系 3: Watermark 传播 `≈` 最小上界计算 {#关系-3-watermark-传播--最小上界计算}](#关系-3-watermark-传播--最小上界计算-关系-3-watermark-传播--最小上界计算)
  - [4. 论证过程 (Argumentation)](#4-论证过程-argumentation)
    ...
    - [反例 4.2 (缺失 ⊥ 元素的格不完备性) {#反例-42-缺失--元素的格不完备性}](#反例-42-缺失-元素的格不完备性)
...
### 示例 6.1: 多流 Join 算子的 Watermark 合并 {#关系-2-watermark-合并--单调性保持-关系-2-watermark-合并--单调性保持}
...
### 示例 6.2: 分布式聚合中的层级 Watermark 传播 {#关系-3-watermark-传播--最小上界计算-关系-3-watermark-传播--最小上界计算}
