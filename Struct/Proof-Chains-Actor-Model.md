...
- [Actor 模型定理完整推导链](#actor-模型定理完整推导链)
  - [目录](#目录)
  - [证明链概览](#证明链概览)
  - [Thm-Chain-Actor-01: 监督树活性定理 (Thm-S-03-09)](#thm-chain-actor-01-监督树活性定理-thm-s-03-09)
    - [依赖图](#依赖图)
    - [步骤说明](#步骤说明)
    - [证明概要](#证明概要)
  - [Thm-Chain-Actor-02: Actor 配置活性 (Thm-S-03-41)](#thm-chain-actor-02-actor-配置活性-thm-s-03-41)
    - [依赖图]()
    - [步骤说明]()
    - [证明概要]()
  - [Thm-Chain-Actor-03: Actor 安全/活性组合性 (Thm-S-10-05)](#thm-chain-actor-03-actor-安全活性组合性-thm-s-10-05)
    - [依赖图]()
    - [步骤说明]()
    - [证明概要]()
  - [Thm-Chain-Actor-04: Actor→CSP 编码保持迹语义 (Thm-S-12-26)](#thm-chain-actor-04-actorcsp-编码保持迹语义-thm-s-12-26)
    - [依赖图]()
    - [步骤说明]()
    - [证明概要]()
  - [Thm-Chain-Actor-05: 动态 Actor 创建不可编码性 (Thm-S-12-67)](#thm-chain-actor-05-动态-actor-创建不可编码性-thm-s-12-67)
    - [依赖图]()
    - [步骤说明]()
    - [证明概要]()
  - [1. 概念定义 (Definitions)](#1-概念定义-definitions)
    - [Def-S-03-16: Actor (经典 Actor 四元组)](#def-s-03-16-actor-经典-actor-四元组)
    - [Def-S-03-56: Behavior (行为)](#def-s-03-56-behavior-行为)
    - [Def-S-03-71: Mailbox (邮箱)](#def-s-03-71-mailbox-邮箱)
    - [Def-S-03-04: ActorRef (Actor 不透明引用)](#def-s-03-04-actorref-actor-不透明引用)
    - [Def-S-03-97: Supervision Tree (监督树)](#def-s-03-97-supervision-tree-监督树)
  - [2. 属性推导 (Properties)](#2-属性推导-properties)
    - [Lemma-S-03-07: 邮箱串行处理引理](#lemma-s-03-07-邮箱串行处理引理)
    - [Lemma-S-03-29: 监督树故障传播有界性](#lemma-s-03-29-监督树故障传播有界性)
    - [Lemma-S-10-07: 安全性有限见证](#lemma-s-10-07-安全性有限见证)
  ...
  - [5. 形式证明 / 工程论证 (Proof / Engineering Argument)]()
    - [Thm-S-03-45: Actor 邮箱串行处理下的局部确定性](#thm-s-03-45-actor-邮箱串行处理下的局部确定性)
    - [Thm-S-03-12: 监督树活性定理](#thm-s-03-12-监督树活性定理)
    - [Thm-S-10-08: Actor 安全/活性组合性](#thm-s-10-08-actor-安全活性组合性)
