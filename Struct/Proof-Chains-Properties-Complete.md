...
- [Properties 层全量引理推导链文档](#properties-层全量引理推导链文档)
  ...
  - [2. 确定性引理簇 (Lemma-S-07-\*)](#2-确定性引理簇-lemma-s-07-)
    ...
    - [2.2 核心引理详解](#22-核心引理详解)
      - [Lemma-S-07-14: 纯函数算子的局部确定性](#lemma-s-07-01-纯函数算子的局部确定性)
      - [Lemma-S-07-40: Watermark 单调性保证触发确定性](#lemma-s-07-02-watermark-单调性保证触发确定性)
      - [Lemma-S-07-56: 分区哈希的确定性](#lemma-s-07-03-分区哈希的确定性)
      - [Lemma-S-07-69: 汇合系统的全局确定性](#lemma-s-07-04-汇合系统的全局确定性)
      - [Lemma-S-07-79: 纯函数性 + FIFO + 事件时间 → 可观测确定性](#lemma-s-07-05-纯函数性--fifo--事件时间--可观测确定性)
      - [Lemma-S-07-88: 无竞争条件 ↔ Keyed 分区状态隔离](#lemma-s-07-06-无竞争条件--keyed-分区状态隔离)
      - [Lemma-S-07-98: 结合律聚合函数对重放记录顺序不敏感](#lemma-s-07-07-结合律聚合函数对重放记录顺序不敏感)
  - [3. 一致性引理簇 (Lemma-S-08-\*)](#3-一致性引理簇-lemma-s-08-)
    - [3.1 一致性层级引理网络](#31-一致性层级引理网络)
    - [3.2 Exactly-Once引理链](#32-exactly-once引理链)
      - [Lemma-S-08-14: Exactly-Once 蕴含 At-Least-Once](#lemma-s-08-01-exactly-once-蕴含-at-least-once)
      - [Lemma-S-08-30: Exactly-Once 蕴含 At-Most-Once](#lemma-s-08-02-exactly-once-蕴含-at-most-once)
      - [Lemma-S-08-42: At-Least-Once 与 At-Most-Once 的误差互补性](#lemma-s-08-03-at-least-once-与-at-most-once-的误差互补性)
      - [Lemma-S-08-50: Strong Consistency 蕴含 Causal Consistency](#lemma-s-08-04-strong-consistency-蕴含-causal-consistency)
      - [Lemma-S-08-57: Causal Consistency 蕴含 Eventual Consistency](#lemma-s-08-05-causal-consistency-蕴含-eventual-consistency)
  - [4. 单调性引理簇 (Lemma-S-09-\*)](#4-单调性引理簇-lemma-s-09-)
    - [4.1 Watermark单调性引理](#41-watermark单调性引理)
      - [Lemma-S-09-05: 最小值保持单调性](#lemma-s-09-01-最小值保持单调性)
  - [5. 活性/安全性引理簇 (Lemma-S-10-\*)](#5-活性安全性引理簇-lemma-s-10-)
    - [5.1 安全性引理](#51-安全性引理)
      - [Lemma-S-10-08: 安全性有限见证](#lemma-s-10-01-安全性有限见证)
    - [5.2 活性引理](#52-活性引理)
      - [Lemma-S-10-15: 活性无限承诺](#lemma-s-10-02-活性无限承诺)
  - [6. 互模拟引理簇 (Lemma-S-15-\*)](#6-互模拟引理簇-lemma-s-15-)
    - [Lemma-S-15-07: 强互模拟是等价关系](#lemma-s-15-01-强互模拟是等价关系)
    - [Lemma-S-15-18: 互模拟蕴含迹等价反之不成立](#lemma-s-15-02-互模拟蕴含迹等价反之不成立)
  - [7. Checkpoint引理簇 (Lemma-S-17-\*)](#7-checkpoint引理簇-lemma-s-17-)
    - [Lemma-S-17-20: Barrier传播不变式](#lemma-s-17-01-barrier传播不变式)
    - [Lemma-S-17-42: 状态一致性引理](#lemma-s-17-02-状态一致性引理)
    - [Lemma-S-17-55: 对齐点唯一性](#lemma-s-17-03-对齐点唯一性)
    - [Lemma-S-17-65: 无孤儿消息保证](#lemma-s-17-04-无孤儿消息保证)
  - [8. 引理依赖网络图](#8-引理依赖网络图)
