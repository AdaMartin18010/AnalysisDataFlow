...
- [推导链: 一致性层级定理完整推导](#推导链-一致性层级定理完整推导)
  ...
  - [1. 概念定义 (Definitions)](#1-概念定义-definitions)
    - [Def-S-07-18: 确定性流计算系统](#def-s-07-01-确定性流计算系统)
    - [Def-S-07-55: 合流规约语义](#def-s-07-02-合流规约语义)
    - [Def-S-08-79: At-Most-Once 语义](#def-s-08-01-at-most-once-语义)
    - [Def-S-08-10: At-Least-Once 语义](#def-s-08-02-at-least-once-语义)
    - [Def-S-08-29: 幂等性](#def-s-08-03-幂等性)
    - [Def-S-08-48: Exactly-Once 语义](#def-s-08-04-exactly-once-语义)
    - [Def-S-09-04: Watermark 定义](#def-s-09-01-watermark-定义)
    - [Def-S-09-21: Watermark 进度语义](#def-s-09-02-watermark-进度语义)
  - [2. 属性推导 (Properties)](#2-属性推导-properties)
    - [Lemma-S-07-08: 确定性蕴含可重现性](#lemma-s-07-01-确定性蕴含可重现性)
    - [Lemma-S-07-32: Watermark 单调性蕴含触发确定性](#lemma-s-07-02-watermark-单调性蕴含触发确定性)
    - [Lemma-S-08-07: 端到端 Exactly-Once 分解](#lemma-s-08-01-端到端-exactly-once-分解)
    - [Lemma-S-08-25: 一致性层级蕴含关系](#lemma-s-08-02-一致性层级蕴含关系)
    - [Lemma-S-09-02: Watermark 推进保证事件时间进展](#lemma-s-09-01-watermark-推进保证事件时间进展)
    - [Prop-S-08-04: 一致性层级严格性](#prop-s-08-01-一致性层级严格性)
  ...
  - [5. 形式证明 / 工程论证 (Proof / Engineering Argument)](#5-形式证明--工程论证-proof--engineering-argument)
    - [Thm-S-07-19: 流计算确定性定理](#thm-s-07-01-流计算确定性定理)
    - [Thm-S-08-05: Exactly-Once 网络分区必要条件](#thm-s-08-01-exactly-once-网络分区必要条件)
    - [Thm-S-08-28: 端到端 Exactly-Once 正确性](#thm-s-08-02-端到端-exactly-once-正确性)
    - [Thm-S-08-58: 统一一致性格定理](#thm-s-08-03-统一一致性格定理)
    - [Thm-S-09-07: Watermark 单调性定理](#thm-s-09-01-watermark-单调性定理)
