# AI Agent 与会话类型 (AI Agent and Session Types) {#关系-2-llm-agent-protocol--choreography-关系-2-llm-agent-protocol--choreography}
...
- [AI Agent 与会话类型 (AI Agent and Session Types)](#ai-agent-与会话类型-ai-agent-and-session-types)
  ...
  - [3. 关系建立 (Relations)](#3-关系建立-relations)
    ...
    - [关系 2: LLM-Agent Protocol ↦ Choreography {#关系-2-llm-agent-protocol--choreography}](#关系-2-llm-agent-protocol--choreography-关系-2-llm-agent-protocol--choreography)
    - [关系 3: Type-safe Agent Communication ↦ Deadlock Freedom {#关系-3-type-safe-agent-communication--deadlock-freedom}](#关系-3-type-safe-agent-communication--deadlock-freedom-关系-3-type-safe-agent-communication--deadlock-freedom)
