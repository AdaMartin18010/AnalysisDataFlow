...
[^1]: Apache Flink FLIP-425, "Async State API: A New Generation of State Access for Apache Flink," 2024. https://cwiki.apache.org/confluence/display/FLINK/FLIP-425%3A+Async+State+API
...
[^5]: L. Lamport, "Time, Clocks, and the Ordering of Events in a Distributed System," *Communications of the ACM*, 21(7), 1978, pp. 558-565.

[^6]: M. J. Fischer, N. A. Lynch, and M. S. Paterson, "Impossibility of Distributed Consensus with One Faulty Process," *Journal of the ACM*, 32(2), 1985, pp. 374-382.

[^7]: S. Krishnamurthy, C. Wu, and M. Franklin, "On-the-fly Sharing for Streamed Aggregation," in *Proc. SIGMOD*, 2005, pp. 623-634.

[^8]: Apache Flink Documentation, "State Backends and State Snapshots," 2025. https://nightlies.apache.org/flink/flink-docs-stable/docs/ops/state/state_backends/
