...
[^1]: McGregor, A. (2014). Graph Stream Algorithms: A Survey. *SIGMOD Record*, 43(1), 9-20. https://doi.org/10.1145/2627692.2627694

[^2]: Aggarwal, C. C., & Subbian, K. (2014). Evolutionary Network Analysis: A Survey. *ACM Computing Surveys*, 47(1), 1-36. https://doi.org/10.1145/2601412

[^3]: Ediger, D., et al. (2012). STINGER: High Performance Data Structure for Streaming Graphs. *IEEE HPC*, 1-5. https://doi.org/10.1109/HPC.2012.1
...
[^5]: Apache Flink Documentation, "Gelly: Flink Graph API", 2025. https://nightlies.apache.org/flink/flink-docs-stable/docs/libs/gelly/

[^6]: Koloniari, G., & Souravlas, S. (2019). A Survey on Graph Streaming Algorithms. *Encyclopedia of Big Data Technologies*, 1-8. https://doi.org/10.1007/978-3-319-63962-8_305-1

[^7]: Sarma, A. D., et al. (2013). Dense Subgraphs on Dynamic Networks. *DISC*, 567-581. https://doi.org/10.1007/978-3-642-41527-2_39

[^8]: Manjunath, M., et al. (2011). Enumerating All Spanning Trees for Pairwise Queries. *Graph Algorithms in the Language of Linear Algebra*, 245-262.

[^9]: Pavan, A., et al. (2013). Counting and Sampling Triangles from a Graph Stream. *PVLDB*, 6(14), 1870-1881. https://doi.org/10.14778/2556549.2556569
...
[^11]: Ahn, K. J., & Guha, S. (2015). Access to Data and Number of Iterations: Dual Primal Algorithms for Maximum Matching under Resource Constraints. *ACM Transactions on Algorithms*, 13(4), 1-25. https://doi.org/10.1145/3056153

[^12]: Cormode, G., et al. (2014). Second-Order Structure in Networks: A Survey. *ACM Computing Surveys*, 47(1), 1-33. https://doi.org/10.1145/2611523

[^13]: Bonifati, A., et al. (2020). Graph Generators: State of the Art and Open Challenges. *ACM Computing Surveys*, 53(2), 1-30. https://doi.org/10.1145/3379448

[^14]: Malewicz, G., et al. (2010). Pregel: A System for Large-Scale Graph Processing. *SIGMOD*, 135-146. https://doi.org/10.1145/1807167.1807184

[^15]: Gonzalez, J. E., et al. (2014). GraphX: Graph Processing in a Distributed Dataflow Framework. *OSDI*, 599-613.

[^16]: Iosup, A., et al. (2016). LDBC Graphalytics: A Benchmark for Large-Scale Graph Analysis on Parallel and Distributed Platforms. *PVLDB*, 9(13), 1317-1328. https://doi.org/10.14778/3007263.3007270

[^17]: Dhulipala, L., et al. (2019). Low-Latency Graph Streaming Using Compressed Purely-Functional Trees. *PLDI*, 918-934. https://doi.org/10.1145/3314221.3314598

[^18]: Labouseur, A. G., et al. (2015). The G* Graph Database: Efficiently Managing Large Distributed Dynamic Graphs. *Distributed and Parallel Databases*, 33(4), 479-514. https://doi.org/10.1007/s10619-015-7175-2

[^19]: Ren, C., et al. (2011). HADOOP-GIS: A High Performance Spatial Data Warehousing System over MapReduce. *PVLDB*, 6(11), 1009-1020. https://doi.org/10.14778/2536222.2536227

[^20]: Holm, J., et al. (2001). Poly-Logarithmic Deterministic Fully-Dynamic Algorithms for Connectivity, Minimum Spanning Tree, 2-Edge, and Biconnectivity. *Journal of the ACM*, 48(4), 723-760. https://doi.org/10.1145/502090.502095
