...
| [../01-foundation/01.02-process-calculus-primer.md](./01.02-process-calculus-primer.md) | CSP/Actor/π 演算基础 | 理论层实例 |
| [../01-foundation/01.03-actor-model-formalization.md](./01.03-actor-model-formalization.md) | Actor 语义、监督树 | 语言-系统映射 |
| [../01-foundation/01.05-csp-formalization.md](./01.05-csp-formalization.md) | CSP 形式化 | 理论层实例 |
