...
- [Flink 到进程演算编码 (Flink-to-Process Calculus Encoding)](#关系-1-flink-dataflow-图--π-演算进程网络)
  - [目录](#目录)
  ...
  - [3. 关系建立 (Relations)](#3-关系建立-relations)
    - [关系 1: Flink Dataflow 图 `↦` π-演算进程网络 {#关系-1-flink-dataflow-图--π-演算进程网络}](#关系-1-flink-dataflow-图--π-演算进程网络)
