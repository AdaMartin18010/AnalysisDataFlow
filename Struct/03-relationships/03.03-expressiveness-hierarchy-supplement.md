...
### Def-S-15-02. Choreographic Programming
...
### Def-S-15-03. CRDTs (Conflict-free Replicated Data Types)
...
### Def-S-15-04. TLA+ (Temporal Logic of Actions)
...
### Lemma-S-15-01. Session Types 类型安全保证
...
### 关系 1: Session Types → Process Calculus 扩展
...
### 关系 2: Choreographic Programming → Actor 分支
...
### 关系 5: Separation Logic → Process Calculus 并发验证
...
### Thm-S-15-01. Session Types 死锁自由定理
...
[^1]: K. Honda, V. T. Vasconcelos, and M. Kubo, "Language Primitives and Type Discipline for Structured Communication-Based Programming," *ESOP*, 1998. —— Session Types 的开创性论文

[^2]: H. H. Dardha, E. Giachino, and D. Sangiorgi, "Session Types Revisited," *Information and Computation*, 256, 253-286, 2017. —— Session Types 的系统化综述
...
[^4]: M. Shapiro, N. Preguiça, C. Baquero, and M. Zawirski, "A Comprehensive Study of Convergent and Commutative Replicated Data Types," INRIA Research Report, 2011. —— CRDTs 的奠基性工作

[^5]: L. Lamport, "Specifying Systems: The TLA+ Language and Tools for Hardware and Software Engineers," Addison-Wesley, 2002. —— TLA+ 权威参考

[^6]: C. A. R. Hoare, "An Axiomatic Basis for Computer Programming," *CACM*, 12(10), 576-580, 1969. —— Hoare 逻辑基础

[^7]: S. S. Ishtiaq and P. W. O'Hearn, "BI as an Assertion Language for Mutable Data Structures," *POPL*, 2001. —— Separation Logic 的起源

[^8]: R. Jung, R. Krebbers, J. Jourdan, A. Bizjak, L. Birkedal, and D. Dreyer, "Iris from the Ground Up: A Modular Foundation for Higher-Order Concurrent Separation Logic," *JFP*, 28, 2018. —— Iris 框架

[^9]: P. A. Bernstein, V. Hadzilacos, and N. Goodman, "Concurrency Control and Recovery in Database Systems," Addison-Wesley, 1987. —— 分布式一致性经典教材

[^10]: M. Kleppmann, "Designing Data-Intensive Applications," O'Reilly, 2017. —— 数据密集型系统设计（含 CRDTs 实践）
