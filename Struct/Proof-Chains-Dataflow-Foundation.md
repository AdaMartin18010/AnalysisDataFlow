...
- [Dataflow 基础定理完整推导链](#dataflow-基础定理完整推导链)
  ...
  - [2. 基础定义层 (Def-S-04-系列)](#2-基础定义层-def-s-04-系列)
    - [Def-S-04-23 (Dataflow 图)](#def-s-04-23-dataflow-图)
    - [Def-S-04-95 (算子语义)](#def-s-04-95-算子语义)
    - [Def-S-04-191 (流作为偏序多重集)](#def-s-04-191-流作为偏序多重集)
    - [Def-S-04-139 (事件时间、处理时间与 Watermark)](#def-s-04-139-事件时间处理时间与-watermark)
  - [3. 性质推导层 (Lemma-S-04-系列)](#3-性质推导层-lemma-s-04-系列)
    - [Lemma-S-04-21 (算子局部确定性)](#lemma-s-04-21-算子局部确定性)
    - [Lemma-S-04-58 (Watermark 单调性)](#lemma-s-04-58-watermark-单调性)
    - [Lemma-S-04-92 (状态算子幂等性)](#lemma-s-04-92-状态算子幂等性)
    - [Lemma-S-04-103 (算子组合封闭性)](#lemma-s-04-103-算子组合封闭性)
  - [4. 定理证明层 (Thm-S-04/07-系列)](#4-定理证明层-thm-s-0407-系列)
    - [Thm-S-04-18 (Dataflow 确定性定理)](#thm-s-04-18-dataflow-确定性定理)
    - [Thm-S-04-74 (算子组合确定性)](#thm-s-04-74-算子组合确定性)
    - [Thm-S-07-29 (流计算确定性定理)](#thm-s-07-29-流计算确定性定理)
